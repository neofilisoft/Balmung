...
public class nethost : ThirdPartyModule
{
    ...
    public override void Setup(BuildOptions options)
    {
        ...
        {
            var type = Balmung.Build.Utilities.GetType($"Balmung.Build.Platforms.{options.Platform.Target}.nethost");
        ...
        options.DependencyFiles.Add(Path.Combine(FolderPath, "BalmungEngine.CSharp.runtimeconfig.json"));
