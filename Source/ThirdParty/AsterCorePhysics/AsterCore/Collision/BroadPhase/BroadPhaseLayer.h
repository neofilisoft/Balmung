...
public:
	...
	ACPH_INLINE						BroadPhaseLayer() = default;
	ACPH_INLINE explicit constexpr	BroadPhaseLayer(Type inValue) : mValue(inValue) { }
	ACPH_INLINE constexpr			BroadPhaseLayer(const BroadPhaseLayer &) = default;
	ACPH_INLINE BroadPhaseLayer &	operator = (const BroadPhaseLayer &) = default;

	ACPH_INLINE constexpr bool		operator == (const BroadPhaseLayer &inRHS) const
	{
	...
	ACPH_INLINE explicit constexpr	operator Type() const
	{
		return mValue;
	}

	ACPH_INLINE Type					GetValue() const
	{
		return mValue;
	}
...
class ACPH_EXPORT BroadPhaseLayerInterface : public NonCopyable
{
public:
	/// Destructor
...
class ACPH_EXPORT ObjectVsBroadPhaseLayerFilter : public NonCopyable
{
public:
	/// Destructor
...
class ACPH_EXPORT BroadPhaseLayerFilter : public NonCopyable
{
public:
	/// Destructor
...
class ACPH_EXPORT DefaultBroadPhaseLayerFilter : public BroadPhaseLayerFilter
{
public:
	/// Constructor
...
class ACPH_EXPORT SpecifiedBroadPhaseLayerFilter : public BroadPhaseLayerFilter
{
public:
	/// Constructor
