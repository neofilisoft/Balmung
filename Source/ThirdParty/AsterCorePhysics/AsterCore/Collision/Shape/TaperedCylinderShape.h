...
class ACPH_EXPORT TaperedCylinderShapeSettings final : public ConvexShapeSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, TaperedCylinderShapeSettings)
...
class ACPH_EXPORT TaperedCylinderShape final : public ConvexShape
{
public:
...
private:
	...
	// Scale the cylinder
	ACPH_INLINE void			GetScaled(Vec3Arg inScale, float &outTop, float &outBottom, float &outTopRadius, float &outBottomRadius, float &outConvexRadius) const;
