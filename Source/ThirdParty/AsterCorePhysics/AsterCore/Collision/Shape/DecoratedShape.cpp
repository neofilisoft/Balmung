...
ACPH_IMPLEMENT_SERIALIZABLE_ABSTRACT(DecoratedShapeSettings)
{
	ACPH_ADD_BASE_CLASS(DecoratedShapeSettings, ShapeSettings)

	ACPH_ADD_ATTRIBUTE(DecoratedShapeSettings, mInnerShape)
}
