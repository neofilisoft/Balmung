...
class ACPH_EXPORT OffsetCenterOfMassShapeSettings final : public DecoratedShapeSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, OffsetCenterOfMassShapeSettings)
...
class ACPH_EXPORT OffsetCenterOfMassShape final : public DecoratedShape
{
public:
