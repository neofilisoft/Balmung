...
class ACPH_EXPORT ConvexHullShapeSettings final : public ConvexShapeSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, ConvexHullShapeSettings)
...
/// A convex hull
class ACPH_EXPORT ConvexHullShape final : public ConvexShape
{
public:
...
private:
	...
	static_assert(alignof(Point) == ACPH_VECTOR_ALIGNMENT, "Unexpected alignment");
