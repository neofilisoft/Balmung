...
class ACPH_EXPORT EmptyShapeSettings final : public ShapeSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, EmptyShapeSettings)
...
class ACPH_EXPORT EmptyShape final : public Shape
{
public:
	// Constructor
