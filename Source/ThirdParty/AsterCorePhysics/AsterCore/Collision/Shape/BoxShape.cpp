...
ACPH_IMPLEMENT_SERIALIZABLE_VIRTUAL(BoxShapeSettings)
{
	ACPH_ADD_BASE_CLASS(BoxShapeSettings, ConvexShapeSettings)

	ACPH_ADD_ATTRIBUTE(BoxShapeSettings, mHalfExtent)
	ACPH_ADD_ATTRIBUTE(BoxShapeSettings, mConvexRadius)
}
...
public:
		...
		mConvexRadius(inConvexRadius)
	{
		...
		ACPH_ASSERT(IsAligned(this, alignof(Box)));
	}
