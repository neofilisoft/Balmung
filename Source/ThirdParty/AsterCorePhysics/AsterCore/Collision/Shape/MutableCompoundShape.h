...
class ACPH_EXPORT MutableCompoundShapeSettings final : public CompoundShapeSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, MutableCompoundShapeSettings)
...
class ACPH_EXPORT MutableCompoundShape final : public CompoundShape
{
public:
...
private:
	...
	ACPH_INLINE void					WalkSubShapes(Visitor &ioVisitor) const;					///< Walk the sub shapes and call Visitor::VisitShape for each sub shape encountered
