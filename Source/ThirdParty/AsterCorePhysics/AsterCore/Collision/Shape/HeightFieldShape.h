...
class ACPH_EXPORT HeightFieldShapeSettings final : public ShapeSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, HeightFieldShapeSettings)
...
class ACPH_EXPORT HeightFieldShape final : public Shape
{
public:
