...
class ACPH_EXPORT DecoratedShapeSettings : public ShapeSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, DecoratedShapeSettings)
...
class ACPH_EXPORT DecoratedShape : public Shape
{
public:
