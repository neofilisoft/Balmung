...
class ACPH_EXPORT CylinderShapeSettings final : public ConvexShapeSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, CylinderShapeSettings)
...
/// A cylinder
class ACPH_EXPORT CylinderShape final : public ConvexShape
{
public:
	...
	// See Shape::GetVolume
	virtual float			GetVolume() const override												{ return 2.0f * ACPH_PI * mHalfHeight * Square(mRadius); }
