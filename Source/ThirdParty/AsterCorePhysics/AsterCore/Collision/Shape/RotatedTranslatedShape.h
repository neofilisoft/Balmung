...
class ACPH_EXPORT RotatedTranslatedShapeSettings final : public DecoratedShapeSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, RotatedTranslatedShapeSettings)
...
class ACPH_EXPORT RotatedTranslatedShape final : public DecoratedShape
{
public:
