...
class ACPH_EXPORT StaticCompoundShapeSettings final : public CompoundShapeSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, StaticCompoundShapeSettings)
...
class ACPH_EXPORT StaticCompoundShape final : public CompoundShape
{
public:
...
private:
	...
	ACPH_INLINE void					WalkTree(Visitor &ioVisitor) const;						///< Walk the node tree calling the Visitor::VisitNodes for each node encountered and Visitor::VisitShape for each sub shape encountered
