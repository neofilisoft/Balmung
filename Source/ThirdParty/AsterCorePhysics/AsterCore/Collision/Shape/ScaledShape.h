...
#include <AsterCore/Physics/Collision/Shape/DecoratedShape.h>
...
class ACPH_EXPORT ScaledShapeSettings final : public DecoratedShapeSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, ScaledShapeSettings)
...
class ACPH_EXPORT ScaledShape final : public DecoratedShape
{
public:
	...
	/// Constructor that decorates another shape with a scale
									ScaledShape(const Shape *inShape, Vec3Arg inScale)		: DecoratedShape(EShapeSubType::Scaled, inShape), mScale(inScale) { ACPH_ASSERT(!ScaleHelpers::IsZeroScale(mScale)); }
