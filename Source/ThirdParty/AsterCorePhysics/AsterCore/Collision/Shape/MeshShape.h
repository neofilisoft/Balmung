...
class ACPH_EXPORT MeshShapeSettings final : public ShapeSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, MeshShapeSettings)
...
class ACPH_EXPORT MeshShape final : public Shape
{
public:
