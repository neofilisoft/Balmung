...
class ACPH_EXPORT ConvexShapeSettings : public ShapeSettings
{
	ACPH_DECLARE_SERIALIZABLE_ABSTRACT(ACPH_EXPORT, ConvexShapeSettings)
...
class ACPH_EXPORT ConvexShape : public Shape
{
public:
	...
	virtual const PhysicsMaterial *	GetMaterial([[maybe_unused]] const SubShapeID &inSubShapeID) const override	{ ACPH_ASSERT(inSubShapeID.IsEmpty(), "Invalid subshape ID"); return GetMaterial(); }
