...
/// data.
class ACPH_EXPORT ShapeSettings : public SerializableObject, public RefTarget<ShapeSettings>
{
	ACPH_DECLARE_SERIALIZABLE_ABSTRACT(ACPH_EXPORT, ShapeSettings)
...
class ACPH_EXPORT ShapeFunctions
{
public:
	/// Construct a shape
...
class ACPH_EXPORT Shape : public RefTarget<Shape>, public NonCopyable
{
public:
	...
	virtual void					RestoreMaterialState([[maybe_unused]] const PhysicsMaterialRefC *inMaterials, [[maybe_unused]] uint inNumMaterials) { ACPH_ASSERT(inNumMaterials == 0); }
	...
	virtual void					RestoreSubShapeState([[maybe_unused]] const ShapeRefC *inSubShapes, [[maybe_unused]] uint inNumShapes) { ACPH_ASSERT(inNumShapes == 0); }
