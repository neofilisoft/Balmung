...
class ACPH_EXPORT TaperedCapsuleShapeSettings final : public ConvexShapeSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, TaperedCapsuleShapeSettings)
...
class ACPH_EXPORT TaperedCapsuleShape final : public ConvexShape
{
public:
