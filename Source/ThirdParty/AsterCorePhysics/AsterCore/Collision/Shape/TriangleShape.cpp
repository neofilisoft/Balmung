...
ACPH_IMPLEMENT_SERIALIZABLE_VIRTUAL(TriangleShapeSettings)
{
	ACPH_ADD_BASE_CLASS(TriangleShapeSettings, ConvexShapeSettings)

	ACPH_ADD_ATTRIBUTE(TriangleShapeSettings, mV1)
	ACPH_ADD_ATTRIBUTE(TriangleShapeSettings, mV2)
	ACPH_ADD_ATTRIBUTE(TriangleShapeSettings, mV3)
	ACPH_ADD_ATTRIBUTE(TriangleShapeSettings, mConvexRadius)
}
...
public:
		...
		mTriangleSupport(inV1, inV2, inV3)
	{
		...
		ACPH_ASSERT(IsAligned(this, alignof(TriangleNoConvex)));
	}
...
public:
		...
		mTriangleSupport(inV1, inV2, inV3)
	{
		...
		ACPH_ASSERT(IsAligned(this, alignof(TriangleWithConvex)));
	}
...
void TriangleShape::GetSubmergedVolume(Mat44Arg inCenterOfMassTransform, Vec3Arg inScale, const Plane &inSurface, float &outTotalVolume, float &outSubmergedVolume, Vec3 &outCenterOfBuoyancy ACPH_IF_DEBUG_RENDERER(, RVec3Arg inBaseOffset)) const
{
...
void TriangleShape::sCollideConvexVsTriangle(const Shape *inShape1, const Shape *inShape2, Vec3Arg inScale1, Vec3Arg inScale2, Mat44Arg inCenterOfMassTransform1, Mat44Arg inCenterOfMassTransform2, const SubShapeIDCreator &inSubShapeIDCreator1, const SubShapeIDCreator &inSubShapeIDCreator2, const CollideShapeSettings &inCollideShapeSettings, CollideShapeCollector &ioCollector, [[maybe_unused]] const ShapeFilter &inShapeFilter)
{
	...
	ACPH_ASSERT(inShape2->GetSubType() == EShapeSubType::Triangle);
...
{
	ACPH_ASSERT(inShape->GetSubType() == EShapeSubType::Triangle);
...
void TriangleShape::GetTrianglesStart(GetTrianglesContext &ioContext, const AABox &inBox, Vec3Arg inPositionCOM, QuatArg inRotation, Vec3Arg inScale) const
{
	...
	ACPH_ASSERT(IsAligned(&ioContext, alignof(TSGetTrianglesContext)));
