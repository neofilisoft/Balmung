...
#ifndef ACPH_DEBUG_RENDERER_EXPORT
	// By default export the debug renderer
	#define ACPH_DEBUG_RENDERER_EXPORT ACPH_EXPORT
#endif // !ACPH_DEBUG_RENDERER_EXPORT
...
/// which means that AsterCore can render a complex scene much more efficiently than when each triangle in that scene would have been drawn through DrawTriangle.
///
...
class ACPH_DEBUG_RENDERER_EXPORT DebugRenderer : public NonCopyable
{
public:
	...
	/// A single triangle
	class ACPH_DEBUG_RENDERER_EXPORT Triangle
	{
	public:
							Triangle() = default;
...
private:
	...
	ACPH_MAKE_HASH_STRUCT(SwingConeLimits, SwingConeLimitsHasher, t.mSwingYHalfAngle, t.mSwingZHalfAngle)
	...
	ACPH_MAKE_HASH_STRUCT(SwingPyramidLimits, SwingPyramidLimitsHasher, t.mMinSwingYAngle, t.mMaxSwingYAngle, t.mMinSwingZAngle, t.mMaxSwingZAngle)
	...
	ACPH_MAKE_HASH_STRUCT(TaperedCylinder, TaperedCylinderHasher, t.mTop, t.mBottom, t.mTopRadius, t.mBottomRadius)
