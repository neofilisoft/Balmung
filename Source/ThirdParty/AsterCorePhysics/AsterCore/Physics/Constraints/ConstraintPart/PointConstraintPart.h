...
{
	ACPH_INLINE bool				ApplyVelocityStep(Body &ioBody1, Body &ioBody2, Vec3Arg inLambda) const
	{
...
public:
	...
	inline void					CalculateConstraintProperties(const Body &inBody1, Mat44Arg inRotation1, Vec3Arg inR1, const Body &inBody2, Mat44Arg inRotation2, Vec3Arg inR2)
	{
		...
		{
			ACPH_IF_DEBUG(mInvI1_R1X = Mat44::sNaN();)
		...
		{
			ACPH_IF_DEBUG(mInvI2_R2X = Mat44::sNaN();)
		}
