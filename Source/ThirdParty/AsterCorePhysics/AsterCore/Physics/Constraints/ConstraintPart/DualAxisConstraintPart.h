...
private:
	...
	ACPH_INLINE bool				ApplyVelocityStep(Body &ioBody1, Body &ioBody2, Vec3Arg inN1, Vec3Arg inN2, const Vec2 &inLambda) const
	{
...
public:
	...
	{
		ACPH_ASSERT(inN1.IsNormalized(1.0e-5f));
		ACPH_ASSERT(inN2.IsNormalized(1.0e-5f));
		...
		{
			ACPH_IF_DEBUG(mInvI1_R1PlusUxN1 = Vec3::sNaN();)
			ACPH_IF_DEBUG(mInvI1_R1PlusUxN2 = Vec3::sNaN();)
		...
		{
			ACPH_IF_DEBUG(mInvI2_R2xN1 = Vec3::sNaN();)
			ACPH_IF_DEBUG(mInvI2_R2xN2 = Vec3::sNaN();)
		}
