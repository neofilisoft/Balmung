...
private:
	...
	ACPH_INLINE bool				ApplyVelocityStep(Body &ioBody1, Body &ioBody2, const Vec2 &inLambda) const
	{
...
public:
	...
	{
		ACPH_ASSERT(inWorldSpaceHingeAxis1.IsNormalized(1.0e-5f));
		ACPH_ASSERT(inWorldSpaceHingeAxis2.IsNormalized(1.0e-5f));
