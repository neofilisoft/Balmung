...
class AngleConstraintPart
{
	...
	ACPH_INLINE bool				ApplyVelocityStep(Body &ioBody1, Body &ioBody2, float inLambda) const
	{
	...
	ACPH_INLINE float				CalculateInverseEffectiveMass(const Body &inBody1, const Body &inBody2, Vec3Arg inWorldSpaceAxis)
	{
		ACPH_ASSERT(inWorldSpaceAxis.IsNormalized(1.0e-4f));
