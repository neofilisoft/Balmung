...
public:
	...
	bool						HasBody(const BodyID &inBodyID) const;
	bool						IsBodyIDAvailable(const BodyID &inBodyID) const;
	...
	BodyCreationSettings		GetBodyCreationSettings(const BodyID &inBodyID) const;
