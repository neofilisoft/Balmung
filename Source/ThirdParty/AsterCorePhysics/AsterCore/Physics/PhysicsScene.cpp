...
ACPH_IMPLEMENT_SERIALIZABLE_NON_VIRTUAL(PhysicsScene)
{
	ACPH_ADD_ATTRIBUTE(PhysicsScene, mBodies)
	ACPH_ADD_ATTRIBUTE(PhysicsScene, mConstraints)
	ACPH_ADD_ATTRIBUTE(PhysicsScene, mSoftBodies)
}

ACPH_IMPLEMENT_SERIALIZABLE_NON_VIRTUAL(PhysicsScene::ConnectedConstraint)
{
	ACPH_ADD_ATTRIBUTE(PhysicsScene::ConnectedConstraint, mSettings)
	ACPH_ADD_ATTRIBUTE(PhysicsScene::ConnectedConstraint, mBody1)
	ACPH_ADD_ATTRIBUTE(PhysicsScene::ConnectedConstraint, mBody2)
}
...
void PhysicsScene::FromPhysicsSystem(const PhysicsSystem *inSystem)
{
	...
	for (const Constraint *c : constraints)
		if (c->GetType() == EConstraintType::TwoBodyConstraint)
		{
			...
			ACPH_ASSERT(b1 != body_id_to_idx.end() && b2 != body_id_to_idx.end());
