...
ACPH_GCC_SUPPRESS_WARNING("-Wshadow") // GCC complains about the 'Constraints' value conflicting with the 'Constraints' typedef
...
class ACPH_EXPORT StateRecorderFilter
{
public:
	/// Destructor
...
class ACPH_EXPORT StateRecorder : public StreamIn, public StreamOut
{
public:
	/// Constructor
