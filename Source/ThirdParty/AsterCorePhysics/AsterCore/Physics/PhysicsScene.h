...
class ACPH_EXPORT PhysicsScene : public RefTarget<PhysicsScene>
{
	ACPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(ACPH_EXPORT, PhysicsScene)
...
public:
	...
	{
		ACPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(ACPH_EXPORT, ConnectedConstraint)
