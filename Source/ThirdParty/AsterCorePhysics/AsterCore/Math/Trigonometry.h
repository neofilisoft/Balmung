...
ACPH_INLINE float Sin(float inX)
{
	Vec4 s, c;
...
ACPH_INLINE float Cos(float inX)
{
	Vec4 s, c;
	Vec4::sReplicate(inX).SinCos(s, c);
	return c.GetX();
...
ACPH_INLINE float Tan(float inX)
{
...
ACPH_INLINE float ASin(float inX)
{
...
ACPH_INLINE float ACos(float inX)
{
...
ACPH_INLINE float ACosApproximate(float inX)
{
...
ACPH_INLINE float ATan2(float inY, float inX)
{
