...
#define ACPH_EL(r, c) mCol[c].mF32[r]
...
{
	ACPH_ASSERT(inQuat.IsNormalized());
...
{
	ACPH_ASSERT(mCol[0][3] == 0.0f);
	ACPH_ASSERT(mCol[1][3] == 0.0f);
	ACPH_ASSERT(mCol[2][3] == 0.0f);
...
Mat44 Mat44::Inversed() const
{
	...
	Type tmp1 = ACPH_NEON_SHUFFLE_F32x4(mCol[0].mValue, mCol[1].mValue, 0, 1, 4, 5);
	Type row1 = ACPH_NEON_SHUFFLE_F32x4(mCol[2].mValue, mCol[3].mValue, 0, 1, 4, 5);
	Type row0 = ACPH_NEON_SHUFFLE_F32x4(tmp1, row1, 0, 2, 4, 6);
	row1 = ACPH_NEON_SHUFFLE_F32x4(row1, tmp1, 1, 3, 5, 7);
	tmp1 = ACPH_NEON_SHUFFLE_F32x4(mCol[0].mValue, mCol[1].mValue, 2, 3, 6, 7);
	Type row3 = ACPH_NEON_SHUFFLE_F32x4(mCol[2].mValue, mCol[3].mValue, 2, 3, 6, 7);
	Type row2 = ACPH_NEON_SHUFFLE_F32x4(tmp1, row3, 0, 2, 4, 6);
	row3 = ACPH_NEON_SHUFFLE_F32x4(row3, tmp1, 1, 3, 5, 7);

	tmp1 = vmulq_f32(row2, row3);
	tmp1 = ACPH_NEON_SHUFFLE_F32x4(tmp1, tmp1, 1, 0, 3, 2);
	Type minor0 = vmulq_f32(row1, tmp1);
	Type minor1 = vmulq_f32(row0, tmp1);
	tmp1 = ACPH_NEON_SHUFFLE_F32x4(tmp1, tmp1, 2, 3, 0, 1);
	minor0 = vsubq_f32(vmulq_f32(row1, tmp1), minor0);
	minor1 = vsubq_f32(vmulq_f32(row0, tmp1), minor1);
	minor1 = ACPH_NEON_SHUFFLE_F32x4(minor1, minor1, 2, 3, 0, 1);
	...
	minor3 = ACPH_NEON_SHUFFLE_F32x4(minor3, minor3, 2, 3, 0, 1);

	tmp1 = ACPH_NEON_SHUFFLE_F32x4(row1, row1, 2, 3, 0, 1);
	tmp1 = vmulq_f32(tmp1, row3);
	tmp1 = ACPH_NEON_SHUFFLE_F32x4(tmp1, tmp1, 1, 0, 3, 2);
	row2 = ACPH_NEON_SHUFFLE_F32x4(row2, row2, 2, 3, 0, 1);
	...
	minor2 = ACPH_NEON_SHUFFLE_F32x4(minor2, minor2, 2, 3, 0, 1);
	...
	return result;
#else
	float m00 = ACPH_EL(0, 0), m10 = ACPH_EL(1, 0), m20 = ACPH_EL(2, 0), m30 = ACPH_EL(3, 0);
	float m01 = ACPH_EL(0, 1), m11 = ACPH_EL(1, 1), m21 = ACPH_EL(2, 1), m31 = ACPH_EL(3, 1);
	float m02 = ACPH_EL(0, 2), m12 = ACPH_EL(1, 2), m22 = ACPH_EL(2, 2), m32 = ACPH_EL(3, 2);
	float m03 = ACPH_EL(0, 3), m13 = ACPH_EL(1, 3), m23 = ACPH_EL(2, 3), m33 = ACPH_EL(3, 3);
...
{
	return Mat44(
		Vec4(ACPH_EL(1, 1), ACPH_EL(1, 2), ACPH_EL(1, 0), 0) * Vec4(ACPH_EL(2, 2), ACPH_EL(2, 0), ACPH_EL(2, 1), 0)
			- Vec4(ACPH_EL(1, 2), ACPH_EL(1, 0), ACPH_EL(1, 1), 0) * Vec4(ACPH_EL(2, 1), ACPH_EL(2, 2), ACPH_EL(2, 0), 0),
		Vec4(ACPH_EL(0, 2), ACPH_EL(0, 0), ACPH_EL(0, 1), 0) * Vec4(ACPH_EL(2, 1), ACPH_EL(2, 2), ACPH_EL(2, 0), 0)
			- Vec4(ACPH_EL(0, 1), ACPH_EL(0, 2), ACPH_EL(0, 0), 0) * Vec4(ACPH_EL(2, 2), ACPH_EL(2, 0), ACPH_EL(2, 1), 0),
		Vec4(ACPH_EL(0, 1), ACPH_EL(0, 2), ACPH_EL(0, 0), 0) * Vec4(ACPH_EL(1, 2), ACPH_EL(1, 0), ACPH_EL(1, 1), 0)
			- Vec4(ACPH_EL(0, 2), ACPH_EL(0, 0), ACPH_EL(0, 1), 0) * Vec4(ACPH_EL(1, 1), ACPH_EL(1, 2), ACPH_EL(1, 0), 0),
		Vec4(0, 0, 0, 1));
}
...
Mat44 Mat44::Inversed3x3() const
{
	...
	return Mat44(
		(Vec4(ACPH_EL(1, 1), ACPH_EL(1, 2), ACPH_EL(1, 0), 0) * Vec4(ACPH_EL(2, 2), ACPH_EL(2, 0), ACPH_EL(2, 1), 0)
			- Vec4(ACPH_EL(1, 2), ACPH_EL(1, 0), ACPH_EL(1, 1), 0) * Vec4(ACPH_EL(2, 1), ACPH_EL(2, 2), ACPH_EL(2, 0), 0)) / det,
		(Vec4(ACPH_EL(0, 2), ACPH_EL(0, 0), ACPH_EL(0, 1), 0) * Vec4(ACPH_EL(2, 1), ACPH_EL(2, 2), ACPH_EL(2, 0), 0)
			- Vec4(ACPH_EL(0, 1), ACPH_EL(0, 2), ACPH_EL(0, 0), 0) * Vec4(ACPH_EL(2, 2), ACPH_EL(2, 0), ACPH_EL(2, 1), 0)) / det,
		(Vec4(ACPH_EL(0, 1), ACPH_EL(0, 2), ACPH_EL(0, 0), 0) * Vec4(ACPH_EL(1, 2), ACPH_EL(1, 0), ACPH_EL(1, 1), 0)
			- Vec4(ACPH_EL(0, 2), ACPH_EL(0, 0), ACPH_EL(0, 1), 0) * Vec4(ACPH_EL(1, 1), ACPH_EL(1, 2), ACPH_EL(1, 0), 0)) / det,
		Vec4(0, 0, 0, 1));
}
