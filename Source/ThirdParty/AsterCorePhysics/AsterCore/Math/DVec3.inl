...
// Create a std::hash/ACPH::Hash for DVec3
ACPH_MAKE_HASHABLE(ACPH::DVec3, t.GetX(), t.GetY(), t.GetZ())
...
void DVec3::CheckW() const
{
	...
	ACPH_ASSERT(reinterpret_cast<const uint64 *>(mF64)[2] == reinterpret_cast<const uint64 *>(mF64)[3]);
