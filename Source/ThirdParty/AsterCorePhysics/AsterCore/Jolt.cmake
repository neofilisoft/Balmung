...
# Root
set(JOLT_PHYSICS_ROOT ${PHYSICS_REPO_ROOT}/AsterCore)
...
set(JOLT_PHYSICS_SRC_FILES
	...
	${JOLT_PHYSICS_ROOT}/AsterCore.cmake
	${JOLT_PHYSICS_ROOT}/AsterCore.h
...
if ("${CMAKE_SYSTEM_NAME}" STREQUAL "Windows")
	# Add natvis file
	set(JOLT_PHYSICS_SRC_FILES ${JOLT_PHYSICS_SRC_FILES} ${JOLT_PHYSICS_ROOT}/AsterCore.natvis)
endif()
...
add_library(AsterCore ${JOLT_PHYSICS_SRC_FILES})
...
if (CMAKE_GENERATOR STREQUAL "Ninja Multi-Config" AND MSVC)
	...
	# See: https://github.com/jrouwe/AsterCorePhysics/issues/1211
	target_precompile_headers(AsterCore PRIVATE "${JOLT_PHYSICS_ROOT}/AsterCore.h")
else()
	target_precompile_headers(AsterCore PRIVATE "$<$<NOT:$<CONFIG:ReleaseCoverage>>:${JOLT_PHYSICS_ROOT}/AsterCore.h>")
endif()
...
if (ACPH_TRACK_SIMULATION_STATS)
	target_compile_definitions(AsterCore PUBLIC ACPH_TRACK_SIMULATION_STATS)
endif()
