...
namespace BalmungEditor.Modules.SourceCodeEditing
{
    ...
    public interface ISourceCodeEditor
    {
        ...
        /// <summary>
        /// Gets the custom arguments for the Balmung.Build tool to add when generating project files for this code editor. Can be used to pick a different project files generator. Empty by default.
        /// </summary>
