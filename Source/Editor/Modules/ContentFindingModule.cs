...
using BalmungEditor.GUI.Docking;
using BalmungEditor.SceneGraph;
using BalmungEditor.Windows.Search;
using FlaxEngine;
using BalmungEngine.GUI;
using BalmungEngine.Windows.Search;

namespace BalmungEditor.Modules
{
    ...
    public class ContentFindingModule : EditorModule
    {
        ...
        public List<SearchResult> Search(string charsToFind)
        {
            ...
            {
                BalmungEngine.Json.JsonSerializer.ParseID(charsToFind, out var id);
                ...
                var actor = BalmungEngine.Object.Find<Actor>(ref id, true);
                if (actor != null)
                {
                    return new List<SearchResult>
                    {
                ...
                var script = BalmungEngine.Object.Find<Script>(ref id, true);
        ...
        {
            // Assets
            { "BalmungEditor.Content.Settings.AudioSettings", "Settings" },
            { "BalmungEditor.Content.Settings.BuildSettings", "Settings" },
            { "BalmungEditor.Content.Settings.GameSettings", "Settings" },
            { "BalmungEditor.Content.Settings.GraphicsSettings", "Settings" },
            { "BalmungEditor.Content.Settings.NetworkSettings", "Settings" },
            { "BalmungEditor.Content.Settings.InputSettings", "Settings" },
            { "BalmungEditor.Content.Settings.LayersAndTagsSettings", "Settings" },
            { "BalmungEditor.Content.Settings.NavigationSettings", "Settings" },
            { "BalmungEditor.Content.Settings.LocalizationSettings", "Settings" },
            { "BalmungEditor.Content.Settings.PhysicsSettings", "Settings" },
            { "BalmungEditor.Content.Settings.TimeSettings", "Settings" },
            { "BalmungEditor.Content.Settings.UWPPlatformSettings", "Settings" },
            { "BalmungEditor.Content.Settings.WindowsPlatformSettings", "Settings" },
        };
    }
}
