...
namespace BalmungEditor.Modules
{
    ...
    public sealed class PrefabsModule : EditorModule
    {
        ...
        public void SelectPrefab()
        {
            ...
            var prefab = BalmungEngine.Content.LoadAsync<Prefab>(prefabId);
        ...
        public void ApplyAll(Actor instance)
        {
            ...
            var prefab = BalmungEngine.Content.LoadAsync<Prefab>(instance.PrefabID);
            if (prefab == null)
            ...
            // Call backend
            var failed = PrefabManager.Internal_ApplyAll(BalmungEngine.Object.GetUnmanagedPtr(instance));
            if (prefabRoot != null)
            {
