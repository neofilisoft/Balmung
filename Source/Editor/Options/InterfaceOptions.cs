...
namespace BalmungEditor.Options
{
    /// <summary>
    ...
    public class InterfaceOptions
    {
        ...
        /// </summary>
        [DefaultValue(BalmungEngine.GUI.Orientation.Horizontal)]
        [EditorDisplay("Interface"), EditorOrder(280), Tooltip("Editor content window orientation.")]
        public BalmungEngine.GUI.Orientation ContentWindowOrientation { get; set; } = BalmungEngine.GUI.Orientation.Horizontal;
        ...
        private static FontAsset DefaultFont => BalmungEngine.Content.LoadAsyncInternal<FontAsset>(EditorAssets.PrimaryFont);
        private static FontAsset ConsoleFont => BalmungEngine.Content.LoadAsyncInternal<FontAsset>(EditorAssets.InconsolataRegularFont);
        ...
        public FontAsset[] FallbackFonts = new FontAsset[1] { BalmungEngine.Content.LoadAsyncInternal<FontAsset>(EditorAssets.FallbackFont) };
