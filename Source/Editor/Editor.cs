...
using BalmungEditor.Content.Thumbnails;
using BalmungEditor.Modules;
using BalmungEditor.Modules.SourceCodeEditing;
using BalmungEditor.Options;
using BalmungEditor.SceneGraph.Actors;
using BalmungEditor.States;
using BalmungEditor.Windows;
using BalmungEditor.Windows.Assets;
using FlaxEngine;
using BalmungEngine.Assertions;
using BalmungEngine.GUI;
using BalmungEngine.Interop;
...
namespace BalmungEditor
{
    ...
    public sealed partial class Editor
    {
        ...
        /// </summary>
        public static string LocalCachePath => Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), string.IsNullOrEmpty(Globals.CompanyName) ? "Balmung" : Globals.CompanyName);
        ...
        /// <summary>
        /// Gets a value indicating whether Balmung is the best in the world.
        /// </summary>
        public bool IsBalmungTheBest => true;
        ...
        internal void Init(StartupFlags flags, Guid startupScene)
        {
            ...
            EngineProject = ProjectInfo.Load(StringUtils.CombinePaths(Globals.StartupFolder, "Balmung.balproj"));
        ...
        {
            BalmungEngine.Networking.NetworkManager.Stop(); // Shutdown any multiplayer from playmode
        ...
        {
            /// <summary>
            /// The <see cref="BalmungEngine.Material"/>.
            /// </summary>
            Material = 0,

            /// <summary>
            /// The <see cref="BalmungEngine.MaterialInstance"/>.
            /// </summary>
            MaterialInstance = 1,

            /// <summary>
            /// The <see cref="BalmungEngine.CollisionData"/>.
            /// </summary>
            CollisionData = 2,

            /// <summary>
            /// The <see cref="BalmungEngine.AnimationGraph"/>.
            /// </summary>
            AnimationGraph = 3,

            /// <summary>
            /// The <see cref="BalmungEngine.SkeletonMask"/>.
            /// </summary>
            SkeletonMask = 4,

            /// <summary>
            /// The <see cref="BalmungEngine.ParticleEmitter"/>.
            /// </summary>
            ParticleEmitter = 5,

            /// <summary>
            /// The <see cref="BalmungEngine.ParticleSystem"/>.
            /// </summary>
            ParticleSystem = 6,

            /// <summary>
            /// The <see cref="BalmungEngine.SceneAnimation"/>.
            /// </summary>
            SceneAnimation = 7,

            /// <summary>
            /// The <see cref="BalmungEngine.MaterialFunction"/>.
            /// </summary>
            MaterialFunction = 8,

            /// <summary>
            /// The <see cref="BalmungEngine.ParticleEmitterFunction"/>.
            /// </summary>
            ParticleEmitterFunction = 9,

            /// <summary>
            /// The <see cref="BalmungEngine.AnimationGraphFunction"/>.
            /// </summary>
            AnimationGraphFunction = 10,

            /// <summary>
            /// The <see cref="BalmungEngine.Animation"/>.
            /// </summary>
            Animation = 11,

            /// <summary>
            /// The <see cref="BalmungEngine.BehaviorTree"/>.
            /// </summary>
            BehaviorTree = 12,
        }
        ...
        public static bool CookMeshCollision(string path, CollisionDataType type, ModelBase model, int modelLodIndex = 0, uint materialSlotsMask = uint.MaxValue, ConvexMeshGenerationFlags convexFlags = ConvexMeshGenerationFlags.None, int convexVertexLimit = 255)
        {
            ...
            return Internal_CookMeshCollision(path, type, BalmungEngine.Object.GetUnmanagedPtr(model), modelLodIndex, materialSlotsMask, convexFlags, convexVertexLimit);
        }
        ...
        private static string GetShaderAssetSourceCode(Asset asset)
        {
            ...
            var source = Internal_GetShaderAssetSourceCode(BalmungEngine.Object.GetUnmanagedPtr(asset));
            if (source == null)
        ...
        public static void GetActorEditorSphere(Actor actor, out BoundingSphere sphere)
        {
            if (actor)
            {
                Internal_GetEditorBoxWithChildren(BalmungEngine.Object.GetUnmanagedPtr(actor), out var box);
        ...
        /// <param name="outputExtension">The output file extension (balmung, json, etc.).</param>
        ...
        {
            return BalmungEngine.Object.GetUnmanagedPtr(Windows.MainWindow);
        }
        ...
        internal void Internal_GetGameWinPtr(bool forceGet, out IntPtr result)
        {
            ...
            if (Windows.GameWin != null && (forceGet || Windows.GameWin.ContainsFocus))
            {
                ...
                if (win != null)
                    result = BalmungEngine.Object.GetUnmanagedPtr(win.Window);
            }
        }
        ...
        internal struct VisualScriptingDebugFlowInfo
        {
            ...
            public BalmungEngine.Object ScriptInstance;
            public uint NodeId;
            public int BoxId;
        }
        ...
        [LibraryImport("FlaxEngine", EntryPoint = "EditorInternal_ReadOutputLogs", StringMarshalling = StringMarshalling.Custom, StringMarshallingCustomType = typeof(BalmungEngine.Interop.StringMarshaller))]
        internal static partial int Internal_ReadOutputLogs([MarshalUsing(typeof(BalmungEngine.Interop.ArrayMarshaller<,>), CountElementName = "outCapacity")] ref string[] outMessages, [MarshalUsing(typeof(BalmungEngine.Interop.ArrayMarshaller<,>), CountElementName = "outCapacity")] ref byte[] outLogTypes, [MarshalUsing(typeof(BalmungEngine.Interop.ArrayMarshaller<,>), CountElementName = "outCapacity")] ref long[] outLogTimes, int outCapacity);

        [LibraryImport("FlaxEngine", EntryPoint = "EditorInternal_SetPlayMode", StringMarshalling = StringMarshalling.Custom, StringMarshallingCustomType = typeof(BalmungEngine.Interop.StringMarshaller))]
        ...
        internal static partial void Internal_GetCollisionWires(IntPtr collisionData, [MarshalUsing(typeof(BalmungEngine.Interop.ArrayMarshaller<,>), CountElementName = "trianglesCount")] out Float3[] triangles, [MarshalUsing(typeof(BalmungEngine.Interop.ArrayMarshaller<,>), CountElementName = "indicesCount")] out int[] indices, out int trianglesCount, out int indicesCount);
