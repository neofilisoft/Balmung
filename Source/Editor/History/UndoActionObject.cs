...
namespace BalmungEditor.History
{
    ...
    {
        /// <summary>
        /// The data value storage to solve issue for balmung objects and editor scene tree nodes which are serialized by ref id.
        /// </summary>
        [Serializable]
        public struct DataValue
        {
            ...
            /// The balmung object.
            /// </summary>
            public BalmungEngine.Object FlaxObject;
            ...
            public DataValue(object value)
            {
                ...
                else if (value is BalmungEngine.Object balmungObject)
                {
                    FlaxObject = balmungObject;
                }
        ...
        // For objects that cannot be referenced in undo action like: BalmungEngine.Object or SceneGraphNode we store them in DataStorage,
        // otherwise here:
        ...
        {
            bool useDataStorageForInstance = targetInstance is BalmungEngine.Object || targetInstance is SceneGraph.SceneGraphNode;
