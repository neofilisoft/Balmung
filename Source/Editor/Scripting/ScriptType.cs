...
namespace BalmungEditor.Scripting
{
    /// <summary>
    ...
    public readonly struct ScriptMemberInfo : IEquatable<ScriptMemberInfo>
    {
        ...
        /// <summary>
        /// Gets the type of the member as <see cref="BalmungEditor.Scripting.IScriptMemberInfo"/>.
        /// </summary>
    ...
    public readonly struct ScriptType : IEquatable<ScriptType>
    {
        ...
        /// <summary>
        /// A <see cref="ScriptType" /> that is BalmungEngine.Object.
        /// </summary>
        public static readonly ScriptType FlaxObject = new ScriptType(typeof(BalmungEngine.Object));
        ...
        /// <summary>
        /// Gets the type of the script as <see cref="BalmungEditor.Scripting.IScriptType"/>.
        /// </summary>
        ...
        public static bool CanCast(ScriptType from, ScriptType to)
        {
            ...
            if (from == Null || to == Null)
                return false;
            return (from.Type != typeof(void) && from.Type != typeof(BalmungEngine.Object)) &&
                   (to.Type != typeof(void) && to.Type != typeof(BalmungEngine.Object)) &&
