...
/// </summary>
API_CLASS(Static, Namespace="BalmungEditor") class ScriptsBuilder
{
...
public:
    ...
    /// <summary>
    /// Gets the full path to the Balmung.Build app.
    /// </summary>
    ...
    /// <summary>
    /// Invokes the Balmung.Build tool in the current project workspace and waits for the process end (blocking). Prints the build tool output to the log. Can be invoked from any thread.
    /// </summary>
    /// <param name="args">The Balmung.Build tool invocation arguments.</param>
    ...
    /// </summary>
    /// <param name="customArgs">The additional Balmung.Build tool invocation arguments.</param>
    /// <returns>True if failed, otherwise false.</returns>
