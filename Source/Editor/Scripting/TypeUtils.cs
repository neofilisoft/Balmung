...
namespace BalmungEngine.Utilities
{
    partial class TypeUtils
    {
        ...
        {
            if (o is BalmungEngine.Object balmungObject && BalmungEngine.Object.GetUnmanagedPtr(balmungObject) != IntPtr.Zero)
            {
                var type = balmungObject.GetType();
                var typeName = balmungObject.TypeName;
        ...
        public static object GetDefaultValue(ScriptType type)
        {
            ...
            if (type.IsValueType)
            {
                ...
                BalmungEditor.Utilities.Utils.InitDefaultValues(value);
                return value;
            }
        ...
        public static ScriptType GetType(string typeName)
        {
            ...
            if (!BalmungEditor.Content.Settings.GameSettings.OptionalPlatformSettings.Contains(typeName))
