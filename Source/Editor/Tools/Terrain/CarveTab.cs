...
namespace BalmungEditor.Tools.Terrain
{
    ...
    public class CarveTab : Tab
    {
        ...
        private void OnSelected(Tab tab)
        {
            ...
            if (Editor.SceneEditing.SelectionCount == 1 && Editor.SceneEditing.Selection[0] is SceneGraph.ActorNode actorNode && actorNode.Actor is BalmungEngine.Terrain)
                return;
            var actor = Level.FindActor<BalmungEngine.Terrain>();
            if (actor)
            {
        ...
        private void OnSelectionChanged()
        {
            ...
            var terrain = terrainNode?.Actor as BalmungEngine.Terrain;
