...
namespace BalmungEditor.Tools.Terrain
{
    ...
    /// </summary>
    /// <seealso cref="BalmungEditor.GUI.Dialogs.Dialog" />
    sealed class CreateTerrainDialog : Dialog
    {
        ...
        private class Options
        {
            ...
            [EditorOrder(120), EditorDisplay("Layout", "LOD Count"), DefaultValue(6), Limit(1, BalmungEngine.Terrain.MaxLODs), Tooltip("The maximum Level Of Details count. The actual amount of LODs may be lower due to provided chunk size (each LOD has 4 times less quads).")]
        ...
        private BalmungEngine.Terrain _terrain;
        ...
        private void OnCreate()
        {
            ...
            var terrain = new BalmungEngine.Terrain();
