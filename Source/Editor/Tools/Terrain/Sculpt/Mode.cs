...
namespace BalmungEditor.Tools.Terrain.Sculpt
{
    ...
    public abstract class Mode
    {
        ...
        public virtual unsafe List<ApplyParams> GetAffectedPatches(Brush brush, ref Options options, SculptTerrainGizmoMode gizmo, BalmungEngine.Terrain terrain)
        {
        ...
        /// <param name="gizmo">The gizmo.</param>
        /// <param name="terrain">The terrain.</param>
        public void Apply(Brush brush, ref Options options, SculptTerrainGizmoMode gizmo, BalmungEngine.Terrain terrain)
        {
