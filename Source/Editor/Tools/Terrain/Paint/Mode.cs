...
using System;
using BalmungEditor.Tools.Terrain.Brushes;
using FlaxEngine;

namespace BalmungEditor.Tools.Terrain.Paint
{
    /// <summary>
    ...
    public abstract class Mode
    {
        ...
        /// <summary>
        /// Gets the index of the active splatmap texture to modify by the tool. It must be equal or higher than zero bu less than <see cref="BalmungEngine.Terrain.MaxSplatmapsCount"/>.
        /// </summary>
        ...
        public unsafe void Apply(Brush brush, ref Options options, PaintTerrainGizmoMode gizmo, BalmungEngine.Terrain terrain)
        {
            ...
            var heightmapSize = chunkSize * BalmungEngine.Terrain.PatchEdgeChunksCount + 1;
            var heightmapLength = heightmapSize * heightmapSize;
            var patchSize = chunkSize * BalmungEngine.Terrain.UnitsPerVertex * BalmungEngine.Terrain.PatchEdgeChunksCount;
            ...
            var unitsPerVertexInv = 1.0f / BalmungEngine.Terrain.UnitsPerVertex;
        ...
        public unsafe struct ApplyParams
        {
            ...
            /// The terrain.
            /// </summary>
            public BalmungEngine.Terrain Terrain;
