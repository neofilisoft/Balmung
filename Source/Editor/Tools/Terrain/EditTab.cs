...
namespace BalmungEditor.Tools.Terrain
{
    ...
    public class EditTab : Tab
    {
        ...
        private class DeletePatchAction : IUndoAction
        {
            ...
            public DeletePatchAction(BalmungEngine.Terrain terrain, ref Int2 patchCoord)
            {
                if (terrain == null)
        ...
        private class EditChunkMaterialAction : IUndoAction
        {
            ...
            public EditChunkMaterialAction(BalmungEngine.Terrain terrain, ref Int2 patchCoord, ref Int2 chunkCoord, MaterialBase toSet)
            {
                if (terrain == null)
                    throw new ArgumentException(nameof(terrain));
            ...
            private void Set(ref Guid id)
            {
                ...
                terrain.SetChunkOverrideMaterial(ref _patchCoord, ref _chunkCoord, BalmungEngine.Content.LoadAsync<MaterialBase>(id));
