...
namespace BalmungEditor.Tools.Terrain.Undo
{
    /// <summary>
    ...
    abstract class EditTerrainMapAction : IUndoAction
    {
        ...
        public BalmungEngine.Terrain Terrain
        {
            get
            {
                ...
                return BalmungEngine.Object.Find<BalmungEngine.Terrain>(ref terrainId);
            }
        }
        ...
        protected EditTerrainMapAction(BalmungEngine.Terrain terrain, int stride)
        {
            _terrain = terrain.ID;
