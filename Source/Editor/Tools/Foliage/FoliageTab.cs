...
namespace BalmungEditor.Tools.Foliage
{
    ...
    public class FoliageTab : Tab
    {
        ...
        private void OnSelected(Tab tab)
        {
            ...
            if (Editor.SceneEditing.SelectionCount == 1 && Editor.SceneEditing.Selection[0] is SceneGraph.ActorNode actorNode && actorNode.Actor is BalmungEngine.Foliage)
                return;
            var actor = Level.FindActor<BalmungEngine.Foliage>();
            if (actor)
            {
        ...
        {
            // Create
            var actor = new BalmungEngine.Foliage
            {
        ...
        private void OnSelectionChanged()
        {
            ...
            var foliage = node?.Actor as BalmungEngine.Foliage;
