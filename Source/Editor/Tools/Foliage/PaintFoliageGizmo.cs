...
using BalmungEditor.Tools.Foliage.Undo;
using FlaxEngine;
...
namespace BalmungEditor.Tools.Foliage
{
    ...
    {
        private BalmungEngine.Foliage _paintFoliage;
        ...
        private BalmungEngine.Foliage SelectedFoliage
        {
            get
            {
        ...
        private void PaintStart(BalmungEngine.Foliage foliage)
        {
