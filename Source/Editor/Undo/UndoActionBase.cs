...
namespace BalmungEditor
{
    ...
    public abstract class UndoActionBase<TData> : IUndoAction where TData : struct
    {
        ...
        {
            get => JsonConvert.DeserializeObject<TData>(_data, BalmungEngine.Json.JsonSerializer.Settings);
            protected set => _data = JsonConvert.SerializeObject(value, Formatting.None, BalmungEngine.Json.JsonSerializer.Settings);
        }
