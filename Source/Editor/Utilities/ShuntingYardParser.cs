...
namespace BalmungEditor.Utilities
{
    ...
    public static class ShuntingYard
    {
        ...
        private static readonly IDictionary<string, double> Variables = new Dictionary<string, double>
        {
            ...
            ["min"] = 60,
            ["h"] = 3600,
            ["cmÂ²"] = (Units.Meters2Units / 100) * (Units.Meters2Units / 100),
            ["cmÂ³"] = (Units.Meters2Units / 100) * (Units.Meters2Units / 100) * (Units.Meters2Units / 100),
            ["dmÂ²"] = (Units.Meters2Units / 10) * (Units.Meters2Units / 10),
            ["dmÂ³"] = (Units.Meters2Units / 10) * (Units.Meters2Units / 10) * (Units.Meters2Units / 10),
            ["l"] = (Units.Meters2Units / 10) * (Units.Meters2Units / 10) * (Units.Meters2Units / 10),
            ["mÂ²"] = Units.Meters2Units * Units.Meters2Units,
            ["mÂ³"] = Units.Meters2Units * Units.Meters2Units * Units.Meters2Units,
            ["kg"] = 1,
            ["g"] = 0.001,
        ...
        private static readonly IDictionary<string, double> UnitSymbols = new Dictionary<string, double>
        {
            ...
            ["cm/sÂ²"] = Units.Meters2Units / 100,
            ["m/s"] = Units.Meters2Units,
            ["m/sÂ²"] = Units.Meters2Units,
