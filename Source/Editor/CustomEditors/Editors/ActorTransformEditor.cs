...
namespace BalmungEditor.CustomEditors.Editors
{
    ...
    public static class ActorTransformEditor
    {
        ...
        /// </summary>
        /// <seealso cref="BalmungEditor.CustomEditors.Editors.Vector3Editor" />
        ...
        /// </summary>
        /// <seealso cref="BalmungEditor.CustomEditors.Editors.QuaternionEditor" />
        ...
        /// </summary>
        /// <seealso cref="BalmungEditor.CustomEditors.Editors.Float3Editor" />
        public class ScaleEditor : Float3Editor
        {
            ...
            public override void Initialize(LayoutElementsContainer layout)
            {
                ...
                if (LinkedLabel != null)
                {
                    var textSize = BalmungEngine.GUI.Style.Current.FontMedium.MeasureText(LinkedLabel.Text.Value);
