...
namespace BalmungEditor.CustomEditors.Editors
{
    ...
    public abstract class CollectionEditor : CustomEditor
    {
        ...
        /// </summary>
        /// <seealso cref="BalmungEditor.CustomEditors.GUI.PropertyNameLabel" />
        private class CollectionItemLabel : PropertyNameLabel
        {
            ...
            public override void Draw()
            {
                ...
                var style = BalmungEngine.GUI.Style.Current;
                ...
                Render2D.DrawSprite(BalmungEditor.Editor.Instance.Icons.DragBar12, _arrangeButtonRect, _arrangeButtonInUse ? Color.Orange : dragBarColor);
        ...
        private class CollectionDropPanel : DropPanel
        {
            ...
            public void Setup(CollectionEditor editor, int index, bool canReorder = true)
            {
                ...
                var icons = BalmungEditor.Editor.Instance.Icons;
                ...
                {
                    var selection = BalmungEditor.Editor.Instance.SceneEditing.Selection[0];
                    if (selection != null)
                    {
                ...
                if (editor.Layout.ContainerControl is DropPanel mainGroup)
                {
                    ...
                    IsClosed = BalmungEditor.Editor.Instance.ProjectCache.IsGroupToggled($"{saveName}:{index}");
                }
                else
                {
                    IsClosed = false;
            ...
            private void OnIsClosedChanged(DropPanel panel)
            {
                ...
                {
                    saveName += $"{mainGroup.HeaderText}";
                    BalmungEditor.Editor.Instance.ProjectCache.SetGroupToggle($"{saveName}:{Index}", panel.IsClosed);
                }
            }
        ...
        public override void Initialize(LayoutElementsContainer layout)
        {
            ...
            _minCount = 0;
            _maxCount = 0;
            _background = BalmungEngine.GUI.Style.Current.CollectionBackgroundColor;
        ...
        public override void Refresh()
        {
            ...
            if (_sizeBox != null)
            {
                ...
                if (Values.HasReferenceValue && Values.ReferenceValue is IList referenceValue && referenceValue.Count != Count)
                    color = BalmungEngine.GUI.Style.Current.BackgroundSelected;
