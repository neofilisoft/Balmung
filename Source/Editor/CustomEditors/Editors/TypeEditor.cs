...
namespace BalmungEditor.CustomEditors.Editors
{
    ...
    /// <summary>
    /// Default implementation of the inspector used to edit reference to the <see cref="BalmungEditor.Scripting.ScriptType"/>. Used to pick classes.
    /// </summary>
    ...
    /// <summary>
    /// Default implementation of the inspector used to edit reference to the <see cref="BalmungEngine.SoftTypeReference"/>. Used to pick classes.
    /// </summary>
