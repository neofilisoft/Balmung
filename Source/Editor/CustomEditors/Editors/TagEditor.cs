...
namespace BalmungEditor.CustomEditors.Editors
{
    ...
    public sealed class TagEditor : CustomEditor
    {
        ...
        internal static ContextMenuBase CreatePicker(Tag value, Tag[] values, PickerData pickerData)
        {
            ...
            var addTagDropPanel = new DropPanel
            {
                ...
                ArrowImageOpened = new SpriteBrush(BalmungEngine.GUI.Style.Current.ArrowDown),
                ArrowImageClosed = new SpriteBrush(BalmungEngine.GUI.Style.Current.ArrowRight),
                Parent = menu,
            ...
            nameTextBox.TextChanged += () =>
            {
                ...
                var currentStyle = BalmungEngine.GUI.Style.Current;
                if (uniqueText)
                {
            ...
            nameTextBox.EditEnd += () =>
            {
                ...
                {
                    nameTextBox.BorderColor = Color.Transparent;
                    nameTextBox.BorderSelectedColor = BalmungEngine.GUI.Style.Current.BackgroundSelected;
                    return;
                }
    ...
    public sealed class TagsEditor : CustomEditor
    {
        ...
        public override void Initialize(LayoutElementsContainer layout)
        {
            ...
            var textSize = BalmungEngine.GUI.Style.Current.FontMedium.MeasureText(buttonText);
