...
namespace BalmungEditor.CustomEditors.Dedicated
{
    ...
    /// </summary>
    /// <seealso cref="BalmungEditor.CustomEditors.Editors.GenericEditor" />
    ...
    public class ActorEditor : ScriptingObjectEditor
    {
        ...
        public override void Initialize(LayoutElementsContainer layout)
        {
            ...
            if (actor != null && actor.HasPrefabLink)
            {
                ...
                var prefab = BalmungEngine.Content.LoadAsync<Prefab>(actor.PrefabID);
                ...
                if (prefab && !prefab.WaitForLoaded())
                {
                    ...
                    if (prefabInstance != null)
                    {
                        ...
                        var nestedPrefab = BalmungEngine.Content.Load<Prefab>(nestedPrefabId);
        ...
        private TreeNode CreateDiffNode(CustomEditor editor)
        {
            ...
            {
                node.TextColor = sceneObject.HasPrefabLink ? BalmungEngine.GUI.Style.Current.ProgressNormal : BalmungEngine.GUI.Style.Current.BackgroundSelected;
        ...
        private void OnDiffRevert(CustomEditor editor)
        {
            ...
            if (editor is RemovedScriptDummy removed)
            {
                ...
                Script.Internal_LinkPrefab(BalmungEngine.Object.GetUnmanagedPtr(restored), ref prefabId, ref prefabObjectId);
            ...
            if (editor is RemovedActorDummy removedActor)
            {
                ...
                Actor.Internal_LinkPrefab(BalmungEngine.Object.GetUnmanagedPtr(restored), ref prefabId, ref prefabObjectId);
                return;
            }
