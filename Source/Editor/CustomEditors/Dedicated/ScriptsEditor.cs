...
namespace BalmungEditor.CustomEditors.Dedicated
{
    ...
    /// </summary>
    /// <seealso cref="BalmungEngine.GUI.Image" />
        ...
        public override void Initialize(LayoutElementsContainer layout)
        {
            ...
            for (int i = 0; i < scripts.Length; i++)
            {
                ...
                if (!hasAllRequirements)
                    group.Panel.HeaderTextColor = BalmungEngine.GUI.Style.Current.Statusbar.Failed;
                ...
                if (script.HasPrefabLink)
                    group.Panel.HeaderTextColor = BalmungEngine.GUI.Style.Current.ProgressNormal;
                ...
                var scriptDrag = new DragImage
                {
                    ...
                    AutoFocus = true,
                    IsScrollable = false,
                    Color = BalmungEngine.GUI.Style.Current.ForegroundGrey,
                    Parent = group.Panel,
