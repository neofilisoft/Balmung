...
namespace BalmungEditor.CustomEditors
{
    internal static partial class CustomEditorsUtil
    {
        ...
        internal static CustomEditor CreateEditor(ValueContainer values, CustomEditor overrideEditor, bool canUseRefPicker = true)
        {
            ...
            if (targetType.IsInterface && canUseRefPicker && values.Count > 0 && values[0] is BalmungEngine.Object)
        ...
        internal static CustomEditor CreateEditor(ScriptType targetType, bool canUseRefPicker = true)
        {
            ...
            if (canUseRefPicker)
            {
                ...
                if (typeof(BalmungEngine.Object).IsAssignableFrom(targetTypeType))
            ...
            // Use custom editor
            {
                ...
                do
                {
                    ...
                    if (!canUseRefPicker && checkType == typeof(BalmungEngine.Object))
                        break;
