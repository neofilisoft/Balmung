...
namespace BalmungEditor.CustomEditors
{
    ...
    /// <summary>
    /// The interface for Editor context that owns the presenter. Can be <see cref="BalmungEditor.Windows.PropertiesWindow"/> or <see cref="BalmungEditor.Windows.Assets.PrefabWindow"/> or other window/panel - custom editor scan use it for more specific features.
    /// </summary>
    ...
    public class CustomEditorPresenter : LayoutElementsContainer
    {
        ...
        /// The panel control.
        /// </summary>
        /// <seealso cref="BalmungEngine.GUI.VerticalPanel" />
        public class PresenterPanel : VerticalPanel
        {
            ...
            public override void Update(float deltaTime)
            {
                ...
                {
                    BalmungEditor.Editor.LogWarning(ex);
        ...
        /// </summary>
        /// <seealso cref="BalmungEditor.CustomEditors.SyncPointEditor" />
        ...
        /// <summary>
        /// The Editor context that owns this presenter. Can be <see cref="BalmungEditor.Windows.PropertiesWindow"/> or <see cref="BalmungEditor.Windows.Assets.PrefabWindow"/> or other window/panel - custom editor scan use it for more specific features.
        /// </summary>
