...
void OnAssemblyLoaded(MAssembly* assembly)
{
    ...
    auto customEditorAttribute = engineAssembly->GetClass("BalmungEngine.CustomEditorAttribute");
    ...
    const auto defaultEditorAttribute = engineAssembly->GetClass("BalmungEngine.DefaultEditorAttribute");
    if (defaultEditorAttribute == nullptr)
    {
        LOG(Warning, "Missing DefaultEditorAttribute class.");
        return;
    }
    const auto customEditor = engineAssembly->GetClass("BalmungEditor.CustomEditors.CustomEditor");
