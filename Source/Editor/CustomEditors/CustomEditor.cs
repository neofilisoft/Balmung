    ...
    public abstract class CustomEditor
    {
        ...
        public virtual void Refresh()
        {
            if (LinkedLabel != null)
            {
                ...
                if (Values.IsObsolete)
                    LinkedLabel.TextColor = LinkedLabel.TextColorHighlighted = BalmungEngine.GUI.Style.Current.ForegroundGrey;
            }
        }
        ...
        public void Copy()
        {
            try
            {
                ...
                {
                    // Object reference
                    text = JsonSerializer.GetStringID(value as BalmungEngine.Object);
                }
                else
                {
                    // Default
