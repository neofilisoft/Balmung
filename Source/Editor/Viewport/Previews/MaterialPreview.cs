...
namespace BalmungEditor.Viewport.Previews
{
    ...
    public class MaterialPreview : AssetPreview, IVisjectSurfaceOwner
    {
        ...
        /// <summary>
        /// Gets or sets the material asset to preview. It can be <see cref="BalmungEngine.Material"/> or <see cref="BalmungEngine.MaterialInstance"/>.
        /// </summary>
        ...
        public int SelectedModelIndex
        {
            ...
            set
            {
                ...
                _previewModel.Model = BalmungEngine.Content.LoadAsyncInternal<Model>("Editor/Primitives/" + Models[value]);
        ...
        private void UpdateMaterial()
        {
            ...
            if (_particleEffect != null)
            {
                ...
                if (_particleEffectMaterial != particleMaterial && particleMaterial)
                {
                    ...
                    {
                        var srcAsset = BalmungEngine.Content.LoadInternal<ParticleEmitter>("Editor/Particles/Particle Material Preview");
                        Editor.Instance.ContentEditing.FastTempAssetClone(srcAsset.Path, out var clonedPath);
                        _particleEffectEmitter = BalmungEngine.Content.Load<ParticleEmitter>(clonedPath);
                    }
        ...
        byte[] ISurfaceContext.SurfaceData
        {
            ...
            set
            {
                ...
                {
                    _particleEffectSystem = BalmungEngine.Content.CreateVirtualAsset<ParticleSystem>();
