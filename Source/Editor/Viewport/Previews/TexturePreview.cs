...
namespace BalmungEditor.Viewport.Previews
{
    ...
    public abstract class TexturePreviewCustomBase : TexturePreviewBase
    {
        ...
        protected TexturePreviewCustomBase(bool useWidgets)
        {
            ...
            var baseMaterial = BalmungEngine.Content.LoadAsyncInternal<Material>("Editor/TexturePreviewMaterial");
    ...
    /// <summary>
    /// Texture preview GUI control. Draws <see cref="BalmungEngine.Texture"/> in the UI and supports view moving/zomming.
    /// </summary>
    /// <seealso cref="TexturePreviewBase" />
    ...
    /// <summary>
    /// Texture preview GUI control. Draws <see cref="BalmungEngine.Texture"/> in the UI and supports view moving/zooming.
    ...
    /// <summary>
    /// Sprite atlas preview GUI control. Draws <see cref="BalmungEngine.SpriteAtlas"/> in the UI and supports view moving/zomming.
    /// Supports texture channels masking and color transformations.
    /// </summary>
    /// <seealso cref="TexturePreviewCustomBase" />
