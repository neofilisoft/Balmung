...
namespace BalmungEditor.Viewport.Previews
{
    ...
    /// </summary>
    /// <seealso cref="BalmungEditor.Viewport.Previews.MaterialPreview" />
    public class CubeTexturePreview : MaterialPreview
    {
        ...
        : base(useWidgets)
        {
            ...
            _previewMaterial = BalmungEngine.Content.CreateVirtualAsset<MaterialInstance>();
            if (_previewMaterial != null)
                _previewMaterial.BaseMaterial = BalmungEngine.Content.LoadAsyncInternal<Material>("Editor/CubeTexturePreviewMaterial");
        ...
        {
            Material = null;
            BalmungEngine.Object.Destroy(ref _previewMaterial);
