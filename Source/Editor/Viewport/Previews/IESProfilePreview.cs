...
namespace BalmungEditor.Viewport.Previews
{
    ...
    /// </summary>
    /// <seealso cref="BalmungEditor.Viewport.Previews.TexturePreviewBase" />
    public class IESProfilePreview : TexturePreviewBase
    {
        ...
        {
            var baseMaterial = BalmungEngine.Content.LoadAsyncInternal<Material>(EditorAssets.IesProfilePreviewMaterial);
