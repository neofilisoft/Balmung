...
namespace BalmungEditor.Viewport.Previews
{
    ...
    /// </summary>
    /// <seealso cref="BalmungEditor.Viewport.EditorViewport" />
    public abstract class AssetPreview : EditorViewport, IEditorPrimitivesOwner
    {
        ...
        /// <summary>
        /// Custom debug drawing event (via <see cref="BalmungEngine.DebugDraw"/>).
        /// </summary>
        ...
        : base(Object.New<SceneRenderTask>(), camera, useWidgets)
        {
            ...
            {
                CustomProbe = BalmungEngine.Content.LoadAsyncInternal<CubeTexture>(EditorAssets.DefaultSkyCubeTexture)
            };
            //
            Sky = new Sky
            {
