...
using Utils = BalmungEditor.Utilities.Utils;
...
namespace BalmungEditor.Viewport
{
    ...
    public class PrefabWindowViewport : PrefabPreview, IGizmoOwner
    {
        ...
        : base(true)
        {
            ...
            // Create post effects
            SelectionOutline = BalmungEngine.Object.New<SelectionOutline>();
            SelectionOutline.SelectionGetter = () => TransformGizmo.SelectedParents;
            Task.AddCustomPostFx(SelectionOutline);
            _spritesRenderer = BalmungEngine.Object.New<PrefabSpritesRenderer>();
        ...
        public override void OnDestroy()
        {
            ...
            BalmungEngine.Object.Destroy(ref _spritesRenderer);
