...
namespace BalmungEditor.Viewport
{
    ...
    /// </summary>
    /// <seealso cref="BalmungEditor.Viewport.EditorGizmoViewport" />
    public class MainEditorGizmoViewport : EditorGizmoViewport, IEditorPrimitivesOwner
    {
        ...
        /// </summary>
        /// <seealso cref="BalmungEngine.PostProcessEffect" />
        [HideInEditor]
        ...
        public override void Update(float deltaTime)
        {
            ...
            var requestUnlockFocus = BalmungEngine.Input.Mouse.GetButtonDown(MouseButton.Right) || BalmungEngine.Input.Mouse.GetButtonDown(MouseButton.Left);
            ...
            else if (_lockedFocus)
            {
                ...
                if (ContainsFocus)
                {
                    ...
                    _lockedFocusOffset -= BalmungEngine.Input.Mouse.ScrollDelta * viewportFocusDistance;
                }
