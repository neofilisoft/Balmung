...
namespace BalmungEditor
{
    ...
    public class ViewportDebugDrawData
    {
        ...
        public ViewportDebugDrawData(int actorsCapacity = 0)
        {
            ...
            _highlightTrianglesModel = BalmungEngine.Content.CreateVirtualAsset<Model>();
        }
        ...
        {
            _actors.Add(BalmungEngine.Object.GetUnmanagedPtr(actor));
        }
        ...
        public virtual void Dispose()
        {
            ...
            BalmungEngine.Object.Destroy(ref _highlightTrianglesModel);
        }
