...
namespace BalmungEditor.SceneGraph.Actors
{
    ...
    public sealed class SpriteRenderNode : ActorNode
    {
        ...
        public override void PostSpawn()
        {
            ...
            sprite.Material = BalmungEngine.Content.LoadAsyncInternal<MaterialBase>(EditorAssets.DefaultSpriteMaterial);
            sprite.Image = BalmungEngine.Content.LoadAsyncInternal<Texture>(EditorAssets.FlaxIconTexture);
        }
    }
}
