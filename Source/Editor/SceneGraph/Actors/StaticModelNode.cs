    ...
    public sealed class StaticModelNode : ActorNode
    {
        ...
        public bool IsPrimitive
        {
            get
            {
                ...
                return path.EndsWith("/Primitives/Cube.balmung", StringComparison.Ordinal) ||
                       path.EndsWith("/Primitives/Sphere.balmung", StringComparison.Ordinal) ||
                       path.EndsWith("/Primitives/Plane.balmung", StringComparison.Ordinal) ||
                       path.EndsWith("/Primitives/Capsule.balmung", StringComparison.Ordinal);
            }
        }
        ...
        public override bool OnVertexSnap(ref Ray ray, Real hitDistance, out Vector3 result)
        {
            ...
            if (model && !model.WaitForLoaded())
            {
                ...
                var lod = model.LODs[lodIndex];
                {
                    ...
                    {
                        var key = BalmungEngine.Object.GetUnmanagedPtr(mesh);
        ...
        private void CreateAuto(StaticModel actor, Spawner spawner, bool singleNode)
        {
            ...
            if (modelPath.EndsWith("/Primitives/Cube.balmung", StringComparison.Ordinal))
            {
            ...
            else if (modelPath.EndsWith("/Primitives/Sphere.balmung", StringComparison.Ordinal))
            {
            ...
            else if (modelPath.EndsWith("/Primitives/Plane.balmung", StringComparison.Ordinal))
            {
            ...
            else if (modelPath.EndsWith("/Primitives/Capsule.balmung", StringComparison.Ordinal))
            {
