...
namespace BalmungEditor.SceneGraph
{
    /// <summary>
    ...
    public abstract class SceneGraphNode
    {
        ...
        protected SceneGraphNode(Guid id)
        {
            ...
            {
                Editor.LogWarning($"Duplicated Scene Graph node with ID {BalmungEngine.Json.JsonSerializer.GetStringID(id)} of type '{duplicate.GetType().FullName}'");
            }
        ...
        /// </summary>
        public virtual void OnContextMenu(BalmungEditor.GUI.ContextMenu.ContextMenu contextMenu, EditorWindow window)
        {
        }
        ...
        {
            var id = ownerId;
            var idPtr = (BalmungEngine.Json.JsonSerializer.GuidInterop*)&id;
