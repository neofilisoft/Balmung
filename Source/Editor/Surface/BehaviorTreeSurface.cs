...
namespace BalmungEditor.Surface
{
    ...
    public class BehaviorTreeSurface : VisjectSurface
    {
        ...
        /// <inheritdoc />
        public BehaviorTreeSurface(IVisjectSurfaceOwner owner, Action onSave, BalmungEditor.Undo undo)
            ...
            for (int i = 0; i < objects.Count; i++)
            {
                ...
                if (assetItem.IsOfType<BehaviorTree>())
                {
                    ...
                    node = Context.SpawnNode(19, 1, args.SurfaceLocation, new object[]
                    {
                        ...
                        BalmungEngine.Json.JsonSerializer.SaveToBytes(instance),
                        null,
                    });
                    BalmungEngine.Object.Destroy(instance);
                }
