...
namespace BalmungEditor.Surface
{
    ...
    public class SurfaceNode : SurfaceControl
    {
        ...
        {
            // Reference: https://github.com/stefnotch/balmung-custom-visject-plugin/blob/a26a98b40f909a0b10c2259b858e058290003dce/Source/Editor/ExpressionGraphSurface.cs#L231
        ...
        public virtual void SetValue(int index, object value, bool graphEdited = true)
        {
            if (_isDuringValuesEditing || (Surface != null && !Surface.CanEdit))
                return;
            if (BalmungEngine.Json.JsonSerializer.ValueEquals(value, Values[index]))
                return;
