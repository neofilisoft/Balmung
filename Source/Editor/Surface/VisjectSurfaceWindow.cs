...
{
    /// <summary>
    /// The base interface for editor windows that use <see cref="BalmungEditor.Surface.VisjectSurface"/> for content editing. 
    /// </summary>
    /// <seealso cref="BalmungEditor.Surface.IVisjectSurfaceOwner" />
    ...
    /// </summary>
    /// <seealso cref="BalmungEditor.Windows.Assets.ClonedAssetEditorWindowBase{TAsset}" />
    /// <seealso cref="BalmungEditor.Surface.IVisjectSurfaceOwner" />
    sealed class AddRemoveParamAction : IUndoAction
    {
        ...
        private void Add()
        {
            ...
            if (IsAdd && Type.Type == typeof(NormalMap))
                param.Value = BalmungEngine.Content.LoadAsyncInternal<Texture>("Engine/Textures/NormalTexture");
    ...
    /// </summary>
    /// <seealso cref="BalmungEditor.CustomEditors.GUI.DraggablePropertyNameLabel" />
    [HideInEditor]
    ...
    /// </summary>
    /// <seealso cref="BalmungEditor.CustomEditors.CustomEditor" />
    public class ParametersEditor : CustomEditor
    {
        ...
        private void OnPropertyLabelSetupContextMenu(PropertyNameLabel label, BalmungEditor.GUI.ContextMenu.ContextMenu menu, CustomEditor linkedEditor)
        {
        ...
        protected virtual void OnParamContextMenu(int index, BalmungEditor.GUI.ContextMenu.ContextMenu menu)
        {
            menu.AddSeparator();
        ...
        private void OnFindReferences(int index)
        {
            var window = (IVisjectSurfaceWindow)Values[0];
            var param = window.VisjectSurface.Parameters[index];
            Editor.Instance.ContentFinding.ShowSearch(window.VisjectSurface, '\"' + BalmungEngine.Json.JsonSerializer.GetStringID(param.ID) + '\"');
        }
    }
    ...
    /// <summary>
    /// The base class for editor windows that use <see cref="BalmungEditor.Surface.VisjectSurface"/> for content editing. 
    /// Note: it uses ClonedAssetEditorWindowBase which is creating cloned asset to edit/preview.
    /// </summary>
    /// <seealso cref="BalmungEditor.Windows.Assets.AssetEditorWindow" />
    /// <seealso cref="BalmungEditor.Surface.IVisjectSurfaceOwner" />
    /// <seealso cref="IVisjectSurfaceWindow" />
    ...
    where TPreview : AssetPreview
    {
        ...
        /// </summary>
        /// <seealso cref="BalmungEditor.Windows.Assets.ClonedAssetEditorWindowBase{TAsset}" />
        /// <seealso cref="BalmungEditor.Surface.IVisjectSurfaceWindow" />
        protected class Tab : BalmungEditor.GUI.Tabs.Tab
        {
            /// <summary>
            /// The presenter.
            /// </summary>
            ...
            public Tab(string text, BalmungEditor.Undo undo = null)
            : base(text)
            {
        ...
        /// The undo.
        /// </summary>
        protected BalmungEditor.Undo _undo;
        ...
        /// </summary>
        public BalmungEditor.Undo Undo => _undo;
