            ...
            private void UpdateUI()
            {
                if ((int)Values[0] == (int)CommonSamplerType.TextureGroup)
                {
                    if (_textureGroupPicker == null)
                    {
                        ...
                        {
                            Location = new Float2(BalmungEditor.Surface.Constants.NodeMarginX + 50, BalmungEditor.Surface.Constants.NodeMarginY + BalmungEditor.Surface.Constants.NodeHeaderSize + BalmungEditor.Surface.Constants.LayoutOffsetY * 5),
                            Width = 100,
                            Parent = this,
                        };
        ...
        public static NodeArchetype[] Nodes =
        {
            new NodeArchetype
            {
                ...
                Elements = new[]
                {
                    ...
                    NodeElementArchetype.Factory.Output(0, string.Empty, typeof(BalmungEngine.Object), 6),
            ...
            new NodeArchetype
            {
                ...
                Elements = new[]
                {
                    ...
                    NodeElementArchetype.Factory.Input(4, "Heightmap Texture", true, typeof(BalmungEngine.Object), 4),
            ...
            new NodeArchetype
            {
                ...
                Elements = new[]
                {
                    NodeElementArchetype.Factory.Input(0, "Texture", true, typeof(BalmungEngine.Object), 0),
            ...
            new NodeArchetype
            {
                ...
                Elements = new[]
                {
                    ...
                    NodeElementArchetype.Factory.Input(0, "Texture", true, typeof(BalmungEngine.Object), 1),
