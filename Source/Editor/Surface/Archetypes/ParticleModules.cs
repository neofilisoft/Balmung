...
namespace BalmungEditor.Surface.Archetypes
{
    ...
    public static class ParticleModules
    {
        ...
        public class ParticleModuleNode : SurfaceNode
        {
            ...
            {
                _enabled = new CheckBox(0, 0, true, BalmungEditor.Surface.Constants.NodeCloseButtonSize)
                {
            ...
            {
                return new Float2(width + BalmungEditor.Surface.Constants.NodeMarginX * 2, height + BalmungEditor.Surface.Constants.NodeMarginY * 2 + 16.0f);
            }
        ...
        /// </summary>
        /// <seealso cref="BalmungEditor.Surface.Archetypes.ParticleModules.ParticleModuleNode" />
