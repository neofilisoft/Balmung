...
namespace BalmungEditor.Surface.Archetypes
{
    public static partial class Animation
    {
        ...
        /// <seealso cref="BalmungEditor.Surface.ISurfaceContext" />
        internal class StateMachine : SurfaceNode, ISurfaceContext
        {
            ...
            {
                var marginX = BalmungEditor.Surface.Constants.NodeMarginX;
                var uiStartPosY = BalmungEditor.Surface.Constants.NodeMarginY + BalmungEditor.Surface.Constants.NodeHeaderSize;
        ...
        /// </summary>
        /// <seealso cref="BalmungEditor.Surface.SurfaceNode" />
        /// <seealso cref="BalmungEditor.Surface.IConnectionInstigator" />
        ...
        internal abstract class StateMachineStateBase : SurfaceNode, IConnectionInstigator
        {
            ...
            private void OnTransitionClicked(StateMachineTransition transition, ref Float2 mouse, ref Float2 mousePosition, MouseButton button)
            {
                ...
                case MouseButton.Right:
                    var contextMenu = new BalmungEditor.GUI.ContextMenu.ContextMenu();
        ...
        internal class StateMachineState : StateMachineStateBase, ISurfaceContext
        {
            ...
            protected override void UpdateRectangles()
            {
                ...
                const float buttonMargin = BalmungEditor.Surface.Constants.NodeCloseButtonMargin;
                const float buttonSize = BalmungEditor.Surface.Constants.NodeCloseButtonSize;
