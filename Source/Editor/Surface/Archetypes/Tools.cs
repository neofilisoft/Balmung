    ...
    public static class Tools
    {
        ...
        private class GetGameplayGlobalNode : SurfaceNode
        {
            ...
            private void UpdateCombo()
            {
                ...
                var asset = BalmungEngine.Content.Load<GameplayGlobals>((Guid)Values[0]);
        ...
        private class AssetReferenceNode : SurfaceNode
        {
            ...
            {
                var asset = BalmungEngine.Content.LoadAsync((Guid)Values[0]);
        ...
        private class ActorReferenceNode : SurfaceNode
        {
            ...
            {
                var id = (Guid)Values[0];
                var actor = BalmungEngine.Object.Find<Actor>(ref id);
                var box = (OutputBox)GetBox(0);
        ...
        internal class AsNode : SurfaceNode
        {
            ...
            : base(id, context, nodeArch, groupArch)
            {
                _picker = new TypePickerControl
                {
                    ...
                    Bounds = new Rectangle(BalmungEditor.Surface.Constants.NodeMarginX + 20, BalmungEditor.Surface.Constants.NodeMarginY + BalmungEditor.Surface.Constants.NodeHeaderSize, 160, 16),
                    Parent = this,
                };
        ...
        private class TypeReferenceNode : SurfaceNode
        {
            ...
            : base(id, context, nodeArch, groupArch)
            {
                _picker = new TypePickerControl
                {
                    ...
                    Bounds = new Rectangle(BalmungEditor.Surface.Constants.NodeMarginX, BalmungEditor.Surface.Constants.NodeMarginY + BalmungEditor.Surface.Constants.NodeHeaderSize, 140, 16),
                    Parent = this,
                };
                _picker.ValueChanged += () => SetValue(0, _picker.ValueTypeName);
            }
        ...
        {
            internal static readonly Float2 DefaultSize = new Float2(BalmungEditor.Surface.Constants.BoxSize);
        ...
        public static NodeArchetype[] Nodes =
        {
            ...
            new NodeArchetype
            {
                ...
                Elements = new[]
                {
                    NodeElementArchetype.Factory.Output(0, string.Empty, typeof(BalmungEngine.Object), 0),
                    NodeElementArchetype.Factory.Input(0, string.Empty, true, typeof(BalmungEngine.Object), 1),
                }
            },
            new NodeArchetype
            {
            ...
            new NodeArchetype
            {
                TypeID = 25,
                Title = "Cast",
                Create = (id, context, arch, groupArch) => new CastNode(id, context, arch, groupArch, new ScriptType(typeof(BalmungEngine.Object))),
                ...
                Elements = new[]
                {
                    ...
                    NodeElementArchetype.Factory.Input(1, string.Empty, true, typeof(BalmungEngine.Object), 1),
                    ...
                    NodeElementArchetype.Factory.Output(2, string.Empty, typeof(BalmungEngine.Object), 4),
                }
            },
            new NodeArchetype
            {
