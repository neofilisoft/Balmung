...
namespace BalmungEditor.Surface.Archetypes
{
    ...
    public static class Particles
    {
        ...
        public enum ValueTypes
        {
            ...
            /// <summary>
            /// <see cref="BalmungEngine.Float2"/>
            /// </summary>
            Float2,

            /// <summary>
            /// <see cref="BalmungEngine.Float3"/>
            /// </summary>
            Float3,

            /// <summary>
            /// <see cref="BalmungEngine.Float4"/>
            /// </summary>
            Float4,
        ...
        public class ParticleEmitterNode : SurfaceNode
        {
            ...
            internal class ModulesHeader : ContainerControl
            {
                ...
                /// The header height.
                /// </summary>
                public const float HeaderHeight = BalmungEditor.Surface.Constants.NodeHeaderSize;
            ...
            public override void Draw()
            {
                ...
                // Options border
                var optionsAreaStart = BalmungEditor.Surface.Constants.NodeHeaderSize + 3.0f;
                var optionsAreaHeight = 7 * BalmungEditor.Surface.Constants.LayoutOffsetY + 6.0f;
        ...
        private sealed class ParticleEmitterFunctionNode : Function.FunctionNode
        {
            ...
            protected override Asset LoadSignature(Guid id, out string[] types, out string[] names)
            {
                types = null;
                names = null;
                var function = BalmungEngine.Content.Load<ParticleEmitterFunction>(id);
                if (function)
