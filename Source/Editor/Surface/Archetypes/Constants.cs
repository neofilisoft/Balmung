    ...
    public static class Constants
    {
        ...
        private class EnumNode : SurfaceNode
        {
            ...
            public override void OnLoaded(SurfaceNodeActions action)
            {
                ...
                _picker = new EnumComboBox(type)
                {
                    ...
                    Bounds = new Rectangle(BalmungEditor.Surface.Constants.NodeMarginX, BalmungEditor.Surface.Constants.NodeMarginY + BalmungEditor.Surface.Constants.NodeHeaderSize, 160, 16),
                    Parent = this,
                };
        ...
        private class ArrayNode : SurfaceNode
        {
            ...
            public override void OnLoaded(SurfaceNodeActions action)
            {
                ...
                _removeButton = new Button(0, _typePicker.Y + BalmungEditor.Surface.Constants.LayoutOffsetY, 20, 20)
                {
                    Text = "-",
            ...
            private void UpdateUI()
            {
                ...
                _removeButton.X = 0;
                ResizeAuto();
                _addButton.X = Width - _addButton.Width - BalmungEditor.Surface.Constants.NodeMarginX;
        ...
        private class DictionaryNode : SurfaceNode
        {
            ...
            public override void OnLoaded(SurfaceNodeActions action)
            {
                ...
                {
                    Bounds = new Rectangle(_keyTypePicker.X, _keyTypePicker.Y + BalmungEditor.Surface.Constants.LayoutOffsetY, _keyTypePicker.Width, _keyTypePicker.Height),
                    Parent = this,
                };
        ...
        public static NodeArchetype[] Nodes =
        {
            ...
            new NodeArchetype
            {
                TypeID = 10,
                Title = "PI",
                Description = "A value specifying the approximation of Ï€ which is 180 degrees",
                Flags = NodeFlags.AllGraphs,
