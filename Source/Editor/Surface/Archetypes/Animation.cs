    ...
    public static partial class Animation
    {
        ...
        public class Sample : SurfaceNode
        {
            ...
            public override void Update(float deltaTime)
            {
                ...
                if (((AnimGraphSurface)Surface).TryGetTraceEvent(this, out var traceEvent) && traceEvent.Asset is BalmungEngine.Animation anim)
                {
        ...
        public class BlendPose : SurfaceNode
        {
            ...
            private void UpdateBoxes()
            {
                ...
                while (_blendPoses.Count < posesCount)
                {
                    ...
                    var arch = new NodeElementArchetype
                    {
                        ...
                        Position = new Float2(
                                              BalmungEditor.Surface.Constants.NodeMarginX - BalmungEditor.Surface.Constants.BoxOffsetX,
                                              BalmungEditor.Surface.Constants.NodeMarginY + BalmungEditor.Surface.Constants.NodeHeaderSize + ylevel * BalmungEditor.Surface.Constants.LayoutOffsetY),
            ...
            {
                float nodeHeight = 10 + (Mathf.Max(_blendPoses.Count, 1) + 3) * BalmungEditor.Surface.Constants.LayoutOffsetY;
                Height = nodeHeight + BalmungEditor.Surface.Constants.NodeMarginY * 2 + BalmungEditor.Surface.Constants.NodeHeaderSize + BalmungEditor.Surface.Constants.NodeFooterSize;
            }
        ...
        private sealed class AnimationGraphFunctionNode : Function.FunctionNode
        {
            ...
            protected override Asset LoadSignature(Guid id, out string[] types, out string[] names)
            {
                types = null;
                names = null;
                var function = BalmungEngine.Content.Load<AnimationGraphFunction>(id);
                if (function)
        ...
        public static NodeArchetype[] Nodes =
        {
            ...
            new NodeArchetype
            {
                ...
                Elements = new[]
                {
                    ...
                    NodeElementArchetype.Factory.Input(3, "Animation Asset", true, typeof(BalmungEngine.Animation), 8),
                    NodeElementArchetype.Factory.Asset(0, Surface.Constants.LayoutOffsetY * 4, 0, typeof(BalmungEngine.Animation)),
                }
            },
            new NodeArchetype
            {
            ...
            new NodeArchetype
            {
                ...
                "\nInside NLA the the order is bottom (first node in balmung) to the top (last node in balmung)." +
