    ...
    public static class Flow
    {
        private class SequenceNode : SurfaceNode
        {
            ...
            private void UpdateUI()
            {
                ...
                _addButton.Location = new Float2(Width - _addButton.Width - BalmungEditor.Surface.Constants.NodeMarginX, Height - 20 - BalmungEditor.Surface.Constants.NodeMarginY - BalmungEditor.Surface.Constants.NodeFooterSize);
