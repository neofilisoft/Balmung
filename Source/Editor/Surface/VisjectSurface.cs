...
using BalmungEditor.Surface.Archetypes;
using BalmungEditor.Surface.ContextMenu;
using BalmungEditor.Surface.GUI;
...
namespace BalmungEditor.Surface
{
    ...
    public partial class VisjectSurface : ContainerControl, IParametersDependantNode
    {
        ...
        /// <summary>
        /// True if surface supports implicit casting of the BalmungEngine.Object types into Boolean value (as simple validate check).
        /// </summary>
        ...
        /// </summary>
        public readonly BalmungEditor.Undo Undo;
        ...
        public VisjectSurface(IVisjectSurfaceOwner owner, Action onSave = null, BalmungEditor.Undo undo = null, SurfaceStyle style = null, List<GroupArchetype> groups = null, bool supportsDebugging = false)
        {
