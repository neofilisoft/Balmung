...
namespace BalmungEditor.Surface.Elements
{
    /// <summary>
    /// Surface boxes base class (for input and output boxes). Boxes can be connected.
    /// </summary>
    /// <seealso cref="BalmungEditor.Surface.SurfaceNodeElementControl" />
    ...
    public abstract class Box : SurfaceNodeElementControl, IConnectionInstigator
    {
        ...
        /// <summary>
        /// The is active flag for the box. Unlike <see cref="BalmungEngine.GUI.Control.Enabled"/>, inactive boxes can still be interacted with, they just will be drawn like disabled boxes
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the active state of the box. Unlike <see cref="BalmungEngine.GUI.Control.Enabled"/>, inactive boxes can still be interacted with, they just will be drawn like disabled boxes
        /// </summary>
