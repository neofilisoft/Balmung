...
using RealValueBox = BalmungEditor.GUI.Input.DoubleValueBox;
#else
using Real = System.Single;
using RealValueBox = BalmungEditor.GUI.Input.FloatValueBox;
#endif
...
namespace BalmungEditor.Surface.Elements
{
    ...
    /// </summary>
    /// <seealso cref="BalmungEditor.Surface.Elements.Box" />
    [HideInEditor]
    public class InputBox : Box
    {
        ...
        private bool GetClipboardValue(out object result, bool deserialize)
        {
            ...
            if (ScriptType.FlaxObject.IsAssignableFrom(type))
            {
                ...
                obj = BalmungEngine.Object.Find<BalmungEngine.Object>(ref id);
            }
            else
            {
                // Default
        ...
        private void OnCopyValue()
        {
            ...
            try
            {
                ...
                else if (value is BalmungEngine.Object asObject)
                {
                    // Object reference
