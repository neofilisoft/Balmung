...
namespace BalmungEditor.Surface
{
    ...
    /// </summary>
    /// <seealso cref="BalmungEditor.Surface.VisjectSurface" />
    [HideInEditor]
    public class ParticleEmitterSurface : VisjectSurface
    {
        internal BalmungEditor.Surface.Archetypes.Particles.ParticleEmitterNode _rootNode;

        /// <summary>
        /// Gets the root node of the emitter graph.
        /// </summary>
        public BalmungEditor.Surface.Archetypes.Particles.ParticleEmitterNode RootNode => _rootNode;

        /// <inheritdoc />
        public override bool UseContextMenuDescriptionPanel => true;

        /// <inheritdoc />
        public ParticleEmitterSurface(IVisjectSurfaceOwner owner, Action onSave, BalmungEditor.Undo undo)
        ...
        {
            if (type.Type == typeof(BalmungEngine.Object))
                return "Texture";
