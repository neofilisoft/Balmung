...
REGISTER_JSON_ASSET(LocalizedStringTable, "BalmungEngine.LocalizedStringTable", true);
...
void LocalizedStringTable::OnGetData(rapidjson_balmung::StringBuffer& buffer) const
{
