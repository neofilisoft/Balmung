...
{
public:
    static bool Create(const StringView& path, rapidjson_balmung::StringBuffer& data, const String& dataTypename);
    static bool Create(const StringView& path, rapidjson_balmung::StringBuffer& data, const char* dataTypename);
