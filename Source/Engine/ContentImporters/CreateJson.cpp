...
bool CreateJson::Create(const StringView& path, rapidjson_balmung::StringBuffer& data, const String& dataTypename)
{
    auto str = dataTypename.ToStringAnsi();
    return Create(path, data, str.Get());
}

bool CreateJson::Create(const StringView& path, rapidjson_balmung::StringBuffer& data, const char* dataTypename)
{
