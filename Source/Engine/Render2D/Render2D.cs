...
namespace BalmungEngine
{
    partial class Render2D
    {
        ...
        public static void DrawTexture(GPUTextureView rt, Rectangle rect)
        {
            ...
            Internal_DrawTexture(BalmungEngine.Object.GetUnmanagedPtr(rt), ref rect, ref color);
        }
        ...
        {
            var color = Color.White;
            Internal_DrawTexture1(BalmungEngine.Object.GetUnmanagedPtr(t), ref rect, ref color);
        }
        ...
        {
            var color = Color.White;
            Internal_DrawTexture2(BalmungEngine.Object.GetUnmanagedPtr(t), ref rect, ref color);
        }
        ...
        {
            var color = Color.White;
            Internal_DrawTexturePoint(BalmungEngine.Object.GetUnmanagedPtr(t), ref rect, ref color);
        }
        ...
        {
            var color = Color.White;
            Internal_DrawMaterial(BalmungEngine.Object.GetUnmanagedPtr(material), ref rect, ref color);
        }
