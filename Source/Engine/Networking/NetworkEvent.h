...
/// </summary>
API_ENUM(Namespace="BalmungEngine.Networking") enum class NetworkEventType
{
    /// <summary>
...
/// </summary>
API_STRUCT(Namespace="BalmungEngine.Networking") struct FLAXENGINE_API NetworkEvent
{
