...
namespace BalmungEngine.Networking
{
    partial class NetworkReplicator
    {
        ...
        private static void ClearManagedReferences()
        {
            ...
            BalmungEditor.ScriptsBuilder.ScriptsReloadBegin -= ClearManagedReferences;
        }
#endif
        ...
        public static void AddSerializer(Type type, SerializeFunc serialize, SerializeFunc deserialize)
        {
            ...
            if (typeof(BalmungEngine.Object).IsAssignableFrom(type))
            {
        ...
        [Unmanaged]
        public static bool InvokeSerializer(Type type, BalmungEngine.Object instance, NetworkStream stream, bool serialize)
        {
            return Internal_InvokeSerializer(type, BalmungEngine.Object.GetUnmanagedPtr(instance), BalmungEngine.Object.GetUnmanagedPtr(stream), serialize);
        }
        ...
        public static bool InvokeSerializer(System.Type type, IntPtr instance, NetworkStream stream, bool serialize)
        {
            if (_managedSerializers != null && _managedSerializers.TryGetValue(type, out var e))
            {
                ...
                serializer(instance, BalmungEngine.Object.GetUnmanagedPtr(stream));
                return false;
            }
            return Internal_InvokeSerializer(type, instance, BalmungEngine.Object.GetUnmanagedPtr(stream), serialize);
        }
        ...
        {
            return Internal_CSharpEndInvokeRPC(BalmungEngine.Object.GetUnmanagedPtr(obj), type, name, BalmungEngine.Object.GetUnmanagedPtr(argsStream), targetIds);
        }

        /// <summary>
        /// Registers a RPC method for a given C# method.
        /// </summary>
        /// <param name="type">The C# type (BalmungEngine.Object).</param>
        ...
        {
            if (!typeof(BalmungEngine.Object).IsAssignableFrom(type))
                throw new ArgumentException("Not supported type for RPC. Only BalmungEngine.Object types are valid.");
