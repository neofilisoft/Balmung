...
/// [Deprecated in v1.3]
/// </summary>
API_ENUM(Namespace="BalmungEngine.Networking") enum class DEPRECATED() NetworkDriverType
{
    /// <summary>
...
/// </summary>
API_STRUCT(Namespace="BalmungEngine.Networking") struct FLAXENGINE_API NetworkConfig
{
