...
/// </summary>
API_CLASS(sealed, Namespace="BalmungEditor.Content.Settings") class FLAXENGINE_API NetworkSettings : public SettingsBase
{
...
public:
    ...
    /// </summary>
    API_FIELD(Attributes="EditorOrder(1100), EditorDisplay(\"Transport\"), TypeReference(typeof(INetworkDriver)), CustomEditorAlias(\"BalmungEditor.CustomEditors.Editors.TypeNameEditor\")")
    StringAnsi NetworkDriver = "BalmungEngine.Networking.ENetDriver";
