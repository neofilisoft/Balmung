...
/// </summary>
API_ENUM(Namespace="BalmungEngine.Networking") enum class NetworkManagerMode
{
    // Disabled.
    Offline = 0,
...
/// </summary>
API_STRUCT(Namespace="BalmungEngine.Networking", NoDefault) struct NetworkClientConnectionData
{
...
/// </summary>
API_CLASS(static, Namespace="BalmungEngine.Networking", Attributes="DebugCommand") class FLAXENGINE_API NetworkManager
{
