...
/// </summary>
API_ENUM(Namespace="BalmungEngine.Networking") enum class NetworkObjectRole : byte
{
...
/// </summary>
API_CLASS(static, Namespace="BalmungEngine.Networking") class FLAXENGINE_API NetworkReplicator
{
