...
namespace fmt_balmung
{
    typedef std_balmung::allocator<Char> allocator;
    typedef std_balmung::allocator<char> allocator_ansi;
    ...
    FORCE_INLINE static void format(fmt::basic_memory_buffer<T, fmt::inline_buffer_size, std_balmung::allocator<T>>& buffer, const T* format, const Args& ... args)
    {
