...
public:
    ...
    {
        fmt_balmung::allocator allocator;
        fmt_balmung::memory_buffer buffer(allocator);
        fmt_balmung::format(buffer, format, args...);
...
public:
    ...
    {
        std_balmung::allocator<char> allocator;
        fmt::basic_memory_buffer<char, fmt::inline_buffer_size, std_balmung::allocator<char>> buffer(allocator);
        fmt_balmung::format(buffer, format, args...);
