...
namespace BalmungEditor.Content.Settings
{
    partial class GameSettings
    {
        internal const string PS4PlatformSettingsTypename = "BalmungEditor.Content.Settings.PS4PlatformSettings";
        internal const string PS5PlatformSettingsTypename = "BalmungEditor.Content.Settings.PS5PlatformSettings";
        internal const string XboxOnePlatformSettingsTypename = "BalmungEditor.Content.Settings.XboxOnePlatformSettings";
        internal const string XboxScarlettPlatformSettingsTypename = "BalmungEditor.Content.Settings.XboxScarlettPlatformSettings";
        internal const string SwitchPlatformSettingsTypename = "BalmungEditor.Content.Settings.SwitchPlatformSettings";
#if FLAX_EDITOR
        ...
        {
            return BalmungEngine.Content.Load<JsonAsset>(GameSettingsAssetPath);
        }
        ...
        private static bool SaveAsset<T>(GameSettings gameSettings, ref JsonAsset asset, T obj) where T : SettingsBase
        {
            ...
            if (Editor.SaveJsonAsset(path, obj))
                return true;
            asset = BalmungEngine.Content.LoadAsync<JsonAsset>(path);
