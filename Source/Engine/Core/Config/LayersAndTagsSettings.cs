...
namespace BalmungEditor.Content.Settings
{
    partial class LayersAndTagsSettings
    {
        ...
        [LibraryImport("FlaxEngine", EntryPoint = "LayersAndTagsSettingsInternal_GetCurrentLayers", StringMarshalling = StringMarshalling.Custom, StringMarshallingCustomType = typeof(BalmungEngine.Interop.StringMarshaller))]
        [return: MarshalUsing(typeof(BalmungEngine.Interop.ArrayMarshaller<,>), CountElementName = "layerCount")]
