...
void ParticleEmitterGPUGenerator::PrepareGraph(ParticleEmitterGraphGPU* graph)
{
    ...
    for (int32 j = 0; j < graph->Parameters.Count(); j++)
    {
        ...
        case VariantType::Enum:
            ...
            if (StringUtils::Compare(param->Type.TypeName, "BalmungEngine.MaterialSceneTextures") == 0)
                mp.Type = MaterialParameterType::SceneTexture;
            else if (StringUtils::Compare(param->Type.TypeName, "BalmungEngine.ChannelMask") == 0)
        ...
        case VariantType::Asset:
            ...
            if (StringUtils::Compare(param->Type.TypeName, "BalmungEngine.Texture") == 0)
                mp.Type = MaterialParameterType::Texture;
            else if (StringUtils::Compare(param->Type.TypeName, "BalmungEngine.CubeTexture") == 0)
        ...
        case VariantType::Object:
            ...
            if (StringUtils::Compare(param->Type.TypeName, "BalmungEngine.GPUTexture") == 0)
