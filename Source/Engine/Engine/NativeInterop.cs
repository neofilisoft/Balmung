    ...
    public static unsafe partial class NativeInterop
    {
...
#else
            // TODO: Use Balmung.Build to generate UnsafeAccessor methods for scripting object fields, fallback to reflection for other types
        ...
        internal static class MarshalHelperReferenceType<T> where T : class
        {
            ...
            internal static void ToNativePointer(ref T managedValue, IntPtr nativePtr)
            {
                ...
                else if (managedValue is BalmungEngine.Object obj)
                    managedPtr = BalmungEngine.Object.GetUnmanagedPtr(obj);
                else
        ...
        private static Type[] GetAssemblyTypes(Assembly assembly)
        {
            ...
            Assert.IsTrue(Utils.GetAssemblies().Count(x => x.GetName().Name == "BalmungEngine.CSharp") == 1);
            return types;
        }
