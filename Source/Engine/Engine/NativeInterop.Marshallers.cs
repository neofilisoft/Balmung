...
namespace BalmungEngine.Interop
{
#if FLAX_EDITOR
    [HideInEditor]
#endif
    ...
    {
        public static Type ConvertToManaged(IntPtr unmanaged) => unmanaged != IntPtr.Zero ? Unsafe.As<BalmungEngine.Interop.NativeInterop.TypeHolder>(ManagedHandleMarshaller.ConvertToManaged(unmanaged)).type : null;
    ...
    [HideInEditor]
#endif
    [CustomMarshaller(typeof(BalmungEngine.Object), MarshalMode.ManagedToUnmanagedIn, typeof(ObjectMarshaller))]
    [CustomMarshaller(typeof(BalmungEngine.Object), MarshalMode.UnmanagedToManagedOut, typeof(ObjectMarshaller))]
    [CustomMarshaller(typeof(BalmungEngine.Object), MarshalMode.ElementIn, typeof(ObjectMarshaller))]
    [CustomMarshaller(typeof(BalmungEngine.Object), MarshalMode.ManagedToUnmanagedOut, typeof(ObjectMarshaller))]
    [CustomMarshaller(typeof(BalmungEngine.Object), MarshalMode.UnmanagedToManagedIn, typeof(ObjectMarshaller))]
    [CustomMarshaller(typeof(BalmungEngine.Object), MarshalMode.ElementOut, typeof(ObjectMarshaller))]
    public static class ObjectMarshaller
    {
        public static BalmungEngine.Object ConvertToManaged(IntPtr unmanaged) => unmanaged != IntPtr.Zero ? Unsafe.As<BalmungEngine.Object>(ManagedHandle.FromIntPtr(unmanaged).Target) : null;
        public static IntPtr ConvertToUnmanaged(BalmungEngine.Object managed) => Unsafe.As<object>(managed) != null ? ManagedHandle.ToIntPtr(managed) : IntPtr.Zero;
    }
