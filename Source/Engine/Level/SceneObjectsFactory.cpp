...
void MissingScript::SetReferenceScript(const ScriptingObjectReference<Script>& value)
{
    ...
    if (Data.IsEmpty() || !_referenceScript)
        return;
    rapidjson_balmung::Document document;
...
void SceneObjectsFactory::HandleObjectDeserializationError(const ISerializable::DeserializeStream& value)
{
    ...
    rapidjson_balmung::StringBuffer buffer;
...
#define CASE(type, typeId) case typeId: typeName = type; break;
    CASE("BalmungEngine.StaticModel", 1);
    CASE("BalmungEngine.Camera", 2);
    CASE("BalmungEngine.EmptyActor", 3);
    CASE("BalmungEngine.DirectionalLight", 4);
    CASE("BalmungEngine.PointLight", 5);
    CASE("BalmungEngine.Skybox", 6);
    CASE("BalmungEngine.EnvironmentProbe", 7);
    CASE("BalmungEngine.BoxBrush", 8);
    CASE("BalmungEngine.Scene", 9);
    CASE("BalmungEngine.Sky", 10);
    CASE("BalmungEngine.RigidBody", 11);
    CASE("BalmungEngine.SpotLight", 12);
    CASE("BalmungEngine.PostFxVolume", 13);
    CASE("BalmungEngine.BoxCollider", 14);
    CASE("BalmungEngine.SphereCollider", 15);
    CASE("BalmungEngine.CapsuleCollider", 16);
    CASE("BalmungEngine.CharacterController", 17);
    CASE("BalmungEngine.FixedJoint", 18);
    CASE("BalmungEngine.DistanceJoint", 19);
    CASE("BalmungEngine.HingeJoint", 20);
    CASE("BalmungEngine.SliderJoint", 21);
    CASE("BalmungEngine.SphericalJoint", 22);
    CASE("BalmungEngine.D6Joint", 23);
    CASE("BalmungEngine.MeshCollider", 24);
    CASE("BalmungEngine.SkyLight", 25);
    CASE("BalmungEngine.ExponentialHeightFog", 26);
    CASE("BalmungEngine.TextRender", 27);
    CASE("BalmungEngine.AudioSource", 28);
    CASE("BalmungEngine.AudioListener", 29);
    CASE("BalmungEngine.AnimatedModel", 30);
    CASE("BalmungEngine.BoneSocket", 31);
    CASE("BalmungEngine.Decal", 32);
    CASE("BalmungEngine.UICanvas", 33);
    CASE("BalmungEngine.UIControl", 34);
    CASE("BalmungEngine.Terrain", 35);
    CASE("BalmungEngine.Foliage", 36);
    CASE("BalmungEngine.NavMeshBoundsVolume", 37);
    CASE("BalmungEngine.NavLink", 38);
    CASE("BalmungEngine.ParticleEffect", 39);
#undef CASE
    default:
