...
public:
    ...
    /// </summary>
    rapidjson_balmung::Document Data;
...
public:
    ...
    static void SerializePrefabInstances(PrefabInstancesData& prefabInstancesData, rapidjson_balmung::StringBuffer& tmpBuffer, const Prefab* prefab);
    ...
    /// <returns>True if failed, otherwise false.</returns>
    static bool SynchronizePrefabInstances(PrefabInstancesData& prefabInstancesData, Actor* defaultInstance, SceneObjectsListCacheType& sceneObjects, const Guid& prefabId, rapidjson_balmung::StringBuffer& tmpBuffer, const Array<Guid>& oldObjectsIds, const Array<Guid>& newObjectIds);
...
void PrefabInstanceData::SerializePrefabInstances(PrefabInstancesData& prefabInstancesData, rapidjson_balmung::StringBuffer& tmpBuffer, const Prefab* prefab)
{
...
bool PrefabInstanceData::SynchronizePrefabInstances(PrefabInstancesData& prefabInstancesData, Actor* defaultInstance, SceneObjectsListCacheType& sceneObjects, const Guid& prefabId, rapidjson_balmung::StringBuffer& tmpBuffer, const Array<Guid>& oldObjectsIds, const Array<Guid>& newObjectIds)
{
    if (prefabInstancesData.IsEmpty())
        return false;
    PROFILE_CPU();
    ...
    rapidjson_balmung::Document defaultInstanceData;
    {
        // Serialize
        tmpBuffer.Clear();
        CompactJsonWriter writerObj(tmpBuffer);
...
bool Prefab::ApplyAll(Actor* targetActor)
{
    ...
    Array<PrefabInstancesData> allPrefabsInstancesData;
    {
        ...
        rapidjson_balmung::StringBuffer dataBuffer;
...
bool Prefab::ApplyAllInternal(Actor* targetActor, bool linkTargetActorObjectToPrefab, PrefabInstancesData& prefabInstancesData)
{
    ...
    rapidjson_balmung::Document diffDataDocument;
    ...
    Dictionary<Guid, Guid> newPrefabInstanceIdToPrefabObjectId; // Maps Prefab Instance Id -> Prefab Object Id (for new actors/scripts to add to prefab), value is a new generated Id of the prefab object for prefab links usage
    {
        ...
        // Generate nested prefab instances to properly handle Ids Mapping within each nested prefab
        rapidjson_balmung::Document targetDataDocument;
...
bool Prefab::UpdateInternal(const Array<SceneObject*>& defaultInstanceObjects, rapidjson_balmung::StringBuffer& tmpBuffer)
{
