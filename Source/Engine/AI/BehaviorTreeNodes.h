...
API_CLASS(Sealed) class FLAXENGINE_API BehaviorTreeRootNode : public BehaviorTreeSequenceNode
{
    ...
    API_FIELD(Attributes="EditorOrder(0), TypeReference(\"\", \"IsValidBlackboardType\"), CustomEditorAlias(\"BalmungEditor.CustomEditors.Editors.TypeNameEditor\")")
    StringAnsi BlackboardType;

    // List of full typenames of the behavior goals (structure or class).
    API_FIELD(Attributes="EditorOrder(10), Collection(OverrideEditorTypeName=\"BalmungEditor.CustomEditors.Editors.TypeNameEditor\")")
