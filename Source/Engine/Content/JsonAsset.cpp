...
void JsonAssetBase::OnGetData(rapidjson_balmung::StringBuffer& buffer) const
{
...
void FindIds(ISerializable::DeserializeStream& node, Array<Guid>& output, Array<String>& files, rapidjson_balmung::Value* nodeName = nullptr)
{
    if (node.IsObject())
    {
...
REGISTER_JSON_ASSET(JsonAsset, "BalmungEngine.JsonAsset", true);
...
void JsonAsset::OnGetData(rapidjson_balmung::StringBuffer& buffer) const
{
