...
const Char* TypeId2TypeName(const uint32 typeId)
{
    ...
    {
    case 1:
        return TEXT("BalmungEngine.Texture");
    case 2:
        return TEXT("BalmungEngine.Material");
    case 3:
        return TEXT("BalmungEngine.Model");
    case 4:
        return TEXT("BalmungEngine.MaterialInstance");
    case 6:
        return TEXT("BalmungEngine.FontAsset");
    case 7:
        return TEXT("BalmungEngine.Shader");
    case 8:
        return TEXT("BalmungEngine.CubeTexture");
    case 10:
        return TEXT("BalmungEngine.SpriteAtlas");
#if USE_EDITOR
    case 11:
        return TEXT("BalmungEditor.PreviewsCache");
#endif
    case 12:
        return TEXT("BalmungEngine.IESProfile");
    case 13:
        return TEXT("BalmungEngine.MaterialBase");
    case 14:
        return TEXT("BalmungEngine.RawDataAsset");
    }
    CRASH;
    return TEXT("");
}
