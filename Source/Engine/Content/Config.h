...
#define ASSET_FILES_EXTENSION TEXT("balmung")
#define ASSET_FILES_EXTENSION_WITH_DOT TEXT(".balmung")

// Default extension for all package files
#define PACKAGE_FILES_EXTENSION TEXT("balmungpac")
#define PACKAGE_FILES_EXTENSION_WITH_DOT TEXT(".balmungpac")
