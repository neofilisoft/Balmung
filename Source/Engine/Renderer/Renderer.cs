...
namespace BalmungEngine
{
    partial class Renderer
    {
        ...
        public static void DrawSceneDepth(GPUContext context, SceneRenderTask task, GPUTexture output, List<Actor> customActors)
        {
            ...
            Internal_DrawSceneDepth(BalmungEngine.Object.GetUnmanagedPtr(context), BalmungEngine.Object.GetUnmanagedPtr(task), BalmungEngine.Object.GetUnmanagedPtr(output), temp, ref tempCount);
        }
