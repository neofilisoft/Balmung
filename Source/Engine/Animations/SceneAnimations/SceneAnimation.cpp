...
REGISTER_BINARY_ASSET(SceneAnimation, "BalmungEngine.SceneAnimation", false);
    ...
    case 4:
    {
        ...
        for (int32 i = 0; i < tracksCount; i++)
        {
            ...
            case Track::Types::CurveProperty:
            {
                ...
                else if (StringUtils::Compare(trackRuntime->PropertyTypeName, "BalmungEngine.Vector2") == 0)
                {
                ...
                else if (StringUtils::Compare(trackRuntime->PropertyTypeName, "BalmungEngine.Vector3") == 0)
                {
                    // Read Float or Double depending on serialized data but use value depending on the current build configuration
                ...
                else if (StringUtils::Compare(trackRuntime->PropertyTypeName, "BalmungEngine.Vector4") == 0)
                {
                    // Read Float or Double depending on serialized data but use value depending on the current build configuration
                ...
                else if (StringUtils::Compare(trackRuntime->PropertyTypeName, "BalmungEngine.Float2") == 0)
                    trackRuntime->DataType = CurvePropertyTrack::DataTypes::Float2;
                else if (StringUtils::Compare(trackRuntime->PropertyTypeName, "BalmungEngine.Float3") == 0)
                    trackRuntime->DataType = CurvePropertyTrack::DataTypes::Float3;
                else if (StringUtils::Compare(trackRuntime->PropertyTypeName, "BalmungEngine.Float4") == 0)
                    trackRuntime->DataType = CurvePropertyTrack::DataTypes::Float4;
                else if (StringUtils::Compare(trackRuntime->PropertyTypeName, "BalmungEngine.Double2") == 0)
                    trackRuntime->DataType = CurvePropertyTrack::DataTypes::Double2;
                else if (StringUtils::Compare(trackRuntime->PropertyTypeName, "BalmungEngine.Double3") == 0)
                    trackRuntime->DataType = CurvePropertyTrack::DataTypes::Double3;
                else if (StringUtils::Compare(trackRuntime->PropertyTypeName, "BalmungEngine.Double4") == 0)
                    trackRuntime->DataType = CurvePropertyTrack::DataTypes::Double4;
                else if (StringUtils::Compare(trackRuntime->PropertyTypeName, "BalmungEngine.Quaternion") == 0)
                    trackRuntime->DataType = CurvePropertyTrack::DataTypes::Quaternion;
                else if (StringUtils::Compare(trackRuntime->PropertyTypeName, "BalmungEngine.Color") == 0)
                    trackRuntime->DataType = CurvePropertyTrack::DataTypes::Color;
                else if (StringUtils::Compare(trackRuntime->PropertyTypeName, "BalmungEngine.Color32") == 0)
