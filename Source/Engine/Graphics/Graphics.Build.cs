...
public class Graphics : EngineModule
{
    ...
    public override void Setup(BuildOptions options)
    {
        ...
        case TargetPlatform.Windows:
            ...
            var windowsToolchain = options.Toolchain as Balmung.Build.Platforms.WindowsToolchain;
            if (windowsToolchain != null && windowsToolchain.SDK != Balmung.Build.Platforms.WindowsPlatformSDK.v8_1)
