...
/// </summary>
API_ENUM(Namespace="BalmungEngine.Online") enum class OnlinePresenceStates
{
    /// <summary>
    /// User is offline.
    /// </summary>
...
/// </summary>
API_STRUCT(Namespace="BalmungEngine.Online") struct FLAXENGINE_API OnlineUser
{
...
/// </summary>
API_STRUCT(Namespace="BalmungEngine.Online") struct FLAXENGINE_API OnlineAchievement
{
...
/// </summary>
API_ENUM(Namespace="BalmungEngine.Online") enum class OnlineLeaderboardSortModes
{
    /// <summary>
    /// Don't sort stats.
    /// </summary>
...
/// </summary>
API_ENUM(Namespace="BalmungEngine.Online") enum class OnlineLeaderboardValueFormats
{
    /// <summary>
    /// Undefined format.
    /// </summary>
...
/// </summary>
API_STRUCT(Namespace="BalmungEngine.Online") struct FLAXENGINE_API OnlineLeaderboard
{
...
/// </summary>
API_STRUCT(Namespace="BalmungEngine.Online") struct FLAXENGINE_API OnlineLeaderboardEntry
{
...
/// </summary>
API_INTERFACE(Namespace="BalmungEngine.Online") class FLAXENGINE_API IOnlinePlatform
{
