...
namespace Balmung.Build
{
    ...
    internal static class MonoCecil
    {
        ...
        {
            if (type.FullName == "BalmungEngine.Object")
                return true;
        ...
        {
            //if (!module.TryGetTypeReference(fullName, out type)) // TODO: this seams to return 'BalmungEngine.Networking.NetworkManagerMode' as a Class instead of Enum
            {
                // Do manual search
