...
namespace Balmung.Build.Bindings
{
    partial class BindingsGenerator
    {
        ...
        private static string GenerateCppGetMClass(BuildData buildData, TypeInfo typeInfo, ApiTypeInfo caller, FunctionInfo functionInfo)
        {
            ...
            case "Vector2": return "Scripting::FindClass(\"BalmungEngine.Vector2\")";
            case "Vector3": return "Scripting::FindClass(\"BalmungEngine.Vector3\")";
            case "Vector4": return "Scripting::FindClass(\"BalmungEngine.Vector4\")";
            }
