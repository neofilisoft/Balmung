        ...
        public class Platforms
        {
            ...
            public static void Package(TargetPlatform platform)
            {
                ...
                // Deploy files
                {
                    ...
                    {
                        Utilities.FileDelete(Path.Combine(dst, "Binaries", "Game", "x64", "Debug", "BalmungGame.a"));
                        Utilities.FileDelete(Path.Combine(dst, "Binaries", "Game", "x64", "Development", "BalmungGame.a"));
                        Utilities.FileDelete(Path.Combine(dst, "Binaries", "Game", "x64", "Release", "BalmungGame.a"));
                        Utilities.FileDelete(Path.Combine(dst, "Binaries", "Game", "x64", "Debug", "BalmungEngine.a"));
                        Utilities.FileDelete(Path.Combine(dst, "Binaries", "Game", "x64", "Development", "BalmungEngine.a"));
                        Utilities.FileDelete(Path.Combine(dst, "Binaries", "Game", "x64", "Release", "BalmungEngine.a"));
                    }
                    ...
                    if (platform == TargetPlatform.Windows && !string.IsNullOrEmpty(Configuration.DeployCert))
                    {
                        ...
                        CodeSign(Path.Combine(binaries, "BalmungGame.exe"));
                        CodeSign(Path.Combine(binaries, "BalmungEngine.dll"));
                        CodeSign(Path.Combine(binaries, "BalmungEngine.CSharp.dll"));
                    ...
                    else if (platform == TargetPlatform.Mac)
                    {
                        ...
                        CodeSign(Path.Combine(binaries, "BalmungGame"));
                        CodeSign(Path.Combine(binaries, "BalmungEngine.dylib"));
