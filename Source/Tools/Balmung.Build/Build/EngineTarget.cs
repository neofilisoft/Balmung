...
namespace Balmung.Build
{
    ...
    /// </summary>
    /// <seealso cref="Balmung.Build.ProjectTarget" />
    public class EngineTarget : ProjectTarget
    {
        ...
        /// </summary>
        public static ProjectInfo EngineProject => ProjectInfo.Load(Path.Combine(Globals.EngineRoot, "Balmung.balproj"));
        ...
        public override void Init()
        {
            ...
            Modules.Add("Main");
            Modules.Add("Engine");
            Win32ResourceFile = Path.Combine(Globals.EngineRoot, "Source", "BalmungEngine.rc");
        }
