...
namespace Balmung.Build
{
    ...
    public class Assembler
    {
        ...
        public static readonly Assembly[] DefaultReferences =
        {
            ...
            typeof(Builder).Assembly, // Balmung.Build.dll
        };
        ...
        public Assembly Build()
        {
            ...
            if (_cacheFolderPath != null)
            {
                ...
                // Construct current configuration and runtime info to be cached alongside with compiled assembly so the build rules are cached only when using the same .NET/Balmung.Build/etc.
