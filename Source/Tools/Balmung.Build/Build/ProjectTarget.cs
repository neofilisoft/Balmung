...
{
    /// <summary>
    /// The build target that is based on .balproj file. Used by engine, game and plugins targets. This target uses standard Flax project structure and is always located in root of the Source directory.
    /// </summary>
    /// <seealso cref="Balmung.Build.Target" />
    public abstract class ProjectTarget : Target
    {
        ...
        public override void Init()
        {
            ...
            // Load project
            var projectFiles = Directory.GetFiles(Path.Combine(FolderPath, ".."), "*.balproj", SearchOption.TopDirectoryOnly);
