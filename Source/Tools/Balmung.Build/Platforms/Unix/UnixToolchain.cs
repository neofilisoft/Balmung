...
namespace Balmung.Build.Platforms
{
    ...
    public abstract class UnixToolchain : Toolchain
    {
        ...
        public static string GetToolchainName(TargetPlatform platform, TargetArchitecture architecture)
        {
            ...
            case TargetPlatform.PS4: return (string)Utilities.GetStaticValue("Balmung.Build.Platforms.PS4Toolchain", "ToolchainName");
            case TargetPlatform.PS5: return (string)Utilities.GetStaticValue("Balmung.Build.Platforms.PS5Toolchain", "ToolchainName");
            ...
            case TargetPlatform.Web:
                switch (architecture)
                {
                case TargetArchitecture.Wasm32: return "wasm32-unknown-emscripten";
                default: throw new InvalidArchitectureException(architecture);
                }
