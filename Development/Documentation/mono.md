...
Custom fork: [https://github.com/FlaxEngine/mono](https://github.com/FlaxEngine/mono) with custom features for C# assemblies hot-reloading at runtime without domain unload (more: [https://balmungengine.com/blog/balmung-facts-16-scripts-hot-reload/](https://balmungengine.com/blog/balmung-facts-16-scripts-hot-reload/)).
...
* When working with mono fork set `localRepoPath` to local repo location in `Source\Tools\Balmung.Build\Deps\Dependencies\mono.cs`
