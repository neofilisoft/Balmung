...
dotnet msbuild /nologo /verbosity:quiet "Source/Tools/Balmung.Build/Balmung.Build.csproj" /property:Configuration=Release /target:Restore,Build /property:RestorePackagesConfig=True /p:RuntimeIdentifiers=linux-x64
