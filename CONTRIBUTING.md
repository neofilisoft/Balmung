...
Go check out our [Trello](https://trello.com/b/NQjLXRCP/balmung-roadmap).
...
* Building or attaching fails
  ...
  * Configure the C# FlaxEngine project by going into the project properties, then the debug tab and selecting "Start external program" `Flax\FlaxEngine\Binaries\Editor\Win64\Debug\BalmungEditor.exe`
